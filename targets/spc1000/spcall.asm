...
0000014E:	PUSH HL
0000014F:	LD H,02h
00000151:	LD BC,4000h		; port 4000: AY8910 PSG address
00000154:	LD A,0Eh		; PSG register 14
00000156:	OUT (C),A
00000158:	CALL 0230h
0000015B:	JP C,01B3h
0000015E:	CALL 03C4h
00000161:	LD A,40h
00000163:	INA (01h)		; port 4001:  AY8910 PSG data port
00000165:	AND 80h
00000167:	JP Z,0158h
0000016A:	LD D,H
...
000001E5:	PUSH HL
000001E6:	LD H,02h
000001E8:	LD BC,4000h		; port 4000: AY8910 PSG address
000001EB:	LD A,0Eh		; PSG register 14
000001ED:	OUT (C),A
000001EF:	CALL 0230h
000001F2:	JP C,01B3h
000001F5:	CALL 03C4h
000001F8:	LD A,40h
000001FA:	INA (01h)		; port 4001:  AY8910 PSG data port
000001FC:	AND 80h
000001FE:	JP Z,01EFh
00000201:	LD D,H
00000202:	POP HL
...
0000023B:	LD A,40h
0000023D:	INA (01h)		; port 4001:  AY8910 PSG data port
0000023F:	AND 80h
...
0000024F:	LD A,40h
00000251:	INA (01h)		; port 4001:  AY8910 PSG data port
00000253:	AND 80h
00000255:	JP Z,0244h
00000258:	RET
...
0000025F:	LD BC,4000h		; port 4000: AY8910 PSG address
00000262:	LD A,0Eh		; PSG register 14
00000264:	OUT (C),A
00000266:	CALL 0230h
00000269:	JP C,028Dh
0000026C:	CALL 03C4h
0000026F:	LD A,40h
00000271:	INA (01h)		; port 4001:  AY8910 PSG data port
00000273:	AND 80h
00000275:	JP Z,0282h
00000278:	PUSH HL
...
000002A3:	LD BC,4000h		; port 4000: AY8910 PSG address
000002A6:	LD A,0Eh		; PSG register 14
000002A8:	OUT (C),A
...
000002B3:	CALL 03C4h
000002B6:	LD A,40h
000002B8:	INA (01h)		; port 4001:  AY8910 PSG data port
000002BA:	AND 80h
000002BC:	JP Z,02AAh
000002BF:	DEC H
...
000002C9:	CALL 03C4h
000002CC:	LD A,40h
000002CE:	INA (01h)		; port 4001:  AY8910 PSG data port
000002D0:	AND 80h
...
000002E1:	PUSH DE
000002E2:	PUSH HL
000002E3:	LD BC,4000h		; port 4000: AY8910 PSG address
000002E6:	LD A,0Eh		; PSG register 14
000002E8:	OUT (C),A
000002EA:	LD L,0Ah
000002EC:	LD BC,6000h
000002EF:	LD A,40h
000002F1:	INA (01h)		; port 4001:  AY8910 PSG data port
000002F3:	AND 40h
...
0000032E:	LD A,40h
00000330:	INA (01h)		; port 4001:  AY8910 PSG data port
00000332:	AND 40h
00000334:	JP Z,02F8h
00000337:	LD A,80h
...
00000346:	PUSH DE
00000347:	LD D,0Ah
00000349:	LD BC,4000h		; port 4000: AY8910 PSG address
0000034C:	LD A,0Eh		; PSG register 14
0000034E:	OUT (C),A
00000350:	LD BC,6000h
00000353:	LD A,40h
00000355:	INA (01h)		; port 4001:  AY8910 PSG data port
00000357:	AND 40h
00000359:	JR Z,+04h
0000035B:	POP DE
0000035C:	POP BC
...
000006B4:	PUSH AF
000006B5:	LD A,(117Fh)		; kbd 'click' flag
000006B8:	OR A
000006B9:	CALL NZ,06D2h		; 'click' sound
000006BC:	POP AF
000006BD:	CP 03h
000006BF:	JP Z,074Ch			; send CTRL-C
000006C2:	CP 0Dh
000006C4:	JP Z,075Fh			; submit BASIC line
000006C7:	JP 08D9h

; BELL
000006CA:	LD DE,0748h		; PSG data for 'BELL'
000006CD:	LD HL,1000h		; sound duration
000006D0:	JR +06h

; 'click' sound
000006D2:	LD DE,0744h		; PSG data
000006D5:	LD HL,00C0h		; sound duration
000006D8:	LD BC,4000h		; port 4000: AY8910 PSG address

000006DB:	PUSH HL
000006DC:	LD HL,0740h		; PSG data backup area
000006DF:	XOR A
000006E0:	OUT (C),A		; PSG register 0
000006E2:	INC C		; port 4001:  AY8910 PSG data port
000006E3:	IN A,(C)
000006E5:	LD (HL),A		; save current PSG register 0
000006E6:	LD A,(DE)		; PSG data register 0 in (DE)
000006E7:	OUT (C),A
000006E9:	DEC C		; port 4000: AY8910 PSG address
000006EA:	INC DE		; inc PSG register data ptr
000006EB:	INC HL
000006EC:	LD A,01h		; PSG register 1
000006EE:	OUT (C),A
000006F0:	INC C		; port 4001:  AY8910 PSG data port
000006F1:	IN A,(C)
000006F3:	LD (HL),A		; save current PSG register 1
000006F4:	LD A,(DE)		; PSG register 1 in (DE+1)
000006F5:	OUT (C),A
000006F7:	DEC C		; port 4000: AY8910 PSG address
000006F8:	INC DE		; inc PSG register data ptr
000006F9:	INC HL
000006FA:	LD A,08h
000006FC:	OUT (C),A
000006FE:	INC C		; port 4001:  AY8910 PSG data port
000006FF:	IN A,(C)
00000701:	LD (HL),A		; save current PSG register 2
00000702:	LD A,(DE)		; PSG register 2 in (DE+2)
00000703:	OUT (C),A
00000705:	DEC C		; port 4000: AY8910 PSG address
00000706:	INC DE		; inc PSG register data ptr
00000707:	INC HL
00000708:	LD A,07h
0000070A:	OUT (C),A
0000070C:	INC C		; port 4001:  AY8910 PSG data port
0000070D:	IN A,(C)
0000070F:	LD (HL),A		; save current PSG register 3
00000710:	LD A,(DE)		; PSG register 3 in (DE+3)
00000711:	OUT (C),A
00000713:	DEC C		; port 4000: AY8910 PSG address
...
0000071A:	LD A,07h
0000071C:	OUT (C),A
0000071E:	INC C		; port 4001:  AY8910 PSG data port
0000071F:	LD A,(HL)		; restore PSG register 0
00000720:	OUT (C),A
00000722:	DEC C		; port 4000: AY8910 PSG address
00000723:	DEC HL
00000724:	LD A,08h
00000726:	OUT (C),A
00000728:	INC C		; port 4001:  AY8910 PSG data port
00000729:	LD A,(HL)		; restore PSG register 1
0000072A:	OUT (C),A
0000072C:	DEC C		; port 4000: AY8910 PSG address
0000072D:	DEC HL
0000072E:	LD A,01h
00000730:	OUT (C),A
00000732:	INC C		; port 4001:  AY8910 PSG data port
00000733:	LD A,(HL)		; restore PSG register 2
00000734:	OUT (C),A
00000736:	DEC C		; port 4000: AY8910 PSG address
00000737:	DEC HL
00000738:	XOR A
00000739:	OUT (C),A
0000073B:	INC C		; port 4001:  AY8910 PSG data port
0000073C:	LD A,(HL)		; restore PSG register 3
0000073D:	OUT (C),A
0000073F:	RET


; PSG data backup area
00000740:	NOP
00000741:	NOP
00000742:	NOP
00000743:	NOP
...
0000080B:	JR C,+0Ch
0000080D:	LD HL,11ECh		; LPOS - line counter for Printer
00000810:	JR Z,+07h
00000812:	LD A,2Ch		; ','
...
00000828:	JR C,+09h
0000082A:	JR NZ,+17h
0000082C:	LD A,(11ECh)		; LPOS - line counter for Printer
0000082F:	OR A
00000830:	RET Z
00000831:	JR +10h
...
0000084D:	JR NZ,+15h
0000084F:	LD A,FFh
00000851:	LD (11ECh),A	; LPOS - line counter for Printer
00000854:	LD A,0Ah
00000856:	JR +0Ch
00000858:	PUSH BC
00000859:	PUSH DE
...
00000880:	LD HL,(11ECh)	; LPOS - line counter for Printer
00000883:	INC L
00000884:	LD (11ECh),HL	; LPOS - line counter for Printer
...
000008A9:	LD BC,4000h		; port 4000: AY8910 PSG address
000008AC:	LD A,07h
000008AE:	OUT (C),A
000008B0:	INC C		; port 4001:  AY8910 PSG data port
000008B1:	IN A,(C)
000008B3:	AND 3Fh
000008B5:	OR 80h
000008B7:	OUT (C),A
000008B9:	DEC C		; port 4000: AY8910 PSG address
000008BA:	RET
...
00000B91:	LD A,(117Fh)		; kbd 'click' flag
00000B94:	XOR 01h
00000B96:	LD (117Fh),A		; kbd 'click' flag
...
00000F5E:	DEC BC
00000F5F:	PUSH BC
00000F60:	LD BC,4000h		; port 4000: AY8910 PSG address
00000F63:	OUT (C),A
00000F65:	INC C		; port 4001:  AY8910 PSG data port
00000F66:	OUT (C),L
00000F68:	POP BC
00000F69:	JR -39h
00000F6B:	CP 4Fh
...
00000FE9:	LD D,(HL)
00000FEA:	INC HL
00000FEB:	LD BC,4000h		; port 4000: AY8910 PSG address
00000FEE:	LD A,(HL)
00000FEF:	OUT (C),D
00000FF1:	INC C		; port 4001:  AY8910 PSG data port
00000FF2:	OUT (C),A
00000FF4:	INC HL
00000FF5:	DEC C		; port 4000: AY8910 PSG address
00000FF6:	INC D
00000FF7:	LD A,(HL)
00000FF8:	OUT (C),D
00000FFA:	INC C		; port 4001:  AY8910 PSG data port
00000FFB:	OUT (C),A
00000FFD:	INC HL
00000FFE:	DEC C		; port 4000: AY8910 PSG address
00000FFF:	LD D,07h
00001001:	OUT (C),D
00001003:	INC C		; port 4001:  AY8910 PSG data port
00001004:	IN A,(C)
00001006:	AND (HL)
00001007:	OUT (C),A
00001009:	INC HL
...
0000102B:	LD A,(BC)
0000102C:	CPL
0000102D:	LD BC,4000h		; port 4000: AY8910 PSG address
00001030:	LD L,07h
00001032:	OUT (C),L
00001034:	INC C		; port 4001:  AY8910 PSG data port
00001035:	IN H,(C)
00001037:	OR H
00001038:	OUT (C),A
0000103A:	RET
...
00001042:	LD BC,4000h		; port 4000: AY8910 PSG address
00001045:	LD L,07h
00001047:	OUT (C),L
00001049:	INC C		; port 4001:  AY8910 PSG data port
0000104A:	IN A,(C)
0000104C:	OR 07h
0000104E:	OUT (C),A
00001050:	XOR A
...
000010D0:	JR NZ,-07h
000010D2:	POP HL
000010D3:	LD BC,4000h		; port 4000: AY8910 PSG address
000010D6:	OUT (C),H
000010D8:	INC C		; port 4001:  AY8910 PSG data port
000010D9:	OUT (C),E
000010DB:	INC H
000010DC:	DEC C	; port 4000: AY8910 PSG address
000010DD:	OUT (C),H
000010DF:	INC C		; port 4001:  AY8910 PSG data port
000010E0:	OUT (C),D
000010E2:	DEC C	; port 4000: AY8910 PSG address
000010E3:	LD A,07h
000010E5:	OUT (C),A
000010E7:	INC C		; port 4001:  AY8910 PSG data port
000010E8:	IN A,(C)
000010EA:	AND L
000010EB:	OUT (C),A
000010ED:	RET

000010EE:	LD BC,4000h		; port 4000: AY8910 PSG address
000010F1:	LD A,07h
000010F3:	OUT (C),A
000010F5:	INC C		; port 4001:  AY8910 PSG data port
000010F6:	IN H,(C)
000010F8:	LD A,L
000010F9:	CPL
000010FA:	OR H
...
00001921:	CP 02h
00001923:	JR C,+05h
00001925:	LD A,(11ECh)	; LPOS - line counter for Printer
00001928:	JR +03h
...
; 'LPOS'
0000374A:	LD A,(11ECh)	; LPOS - line counter for Printer
0000374D:	JR +03h
...
0000473A:	LD L,A
0000473B:	PUSH BC
0000473C:	LD BC,4000h		; port 4000: AY8910 PSG address
0000473F:	OUT (C),H
00004741:	INC C		; port 4001:  AY8910 PSG data port
00004742:	OUT (C),L
00004744:	POP BC
00004745:	JP 1B39h
...
0000477C:	LD BC,4000h		; port 4000: AY8910 PSG address
0000477F:	LD A,07h
00004781:	OUT (C),A
00004783:	INC C		; port 4001:  AY8910 PSG data port
00004784:	IN A,(C)
00004786:	OR 3Fh
00004788:	OUT (C),A
0000478A:	POP HL
...
0000FC9F:	LD A,40h
0000FCA1:	INA (01h)		; port 4001:  AY8910 PSG data port
0000FCA3:	AND 80h
...
0000FCB3:	LD A,40h
0000FCB5:	INA (01h)		; port 4001:  AY8910 PSG data port
0000FCB7:	AND 80h
0000FCB9:	JP Z,FCA8h
0000FCBC:	RET
0000FCBD:	PUSH BC
...
0000FCC3:	LD BC,4000h		; port 4000: AY8910 PSG address
0000FCC6:	LD A,0Eh
0000FCC8:	OUT (C),A
0000FCCA:	CALL FC94h
0000FCCD:	JP C,FCF1h
0000FCD0:	CALL FDF6h
0000FCD3:	LD A,40h
0000FCD5:	INA (01h)		; port 4001:  AY8910 PSG data port
0000FCD7:	AND 80h
0000FCD9:	JP Z,FCE6h
0000FCDC:	PUSH HL
...
0000FD07:	LD BC,4000h		; port 4000: AY8910 PSG address
0000FD0A:	LD A,0Eh
0000FD0C:	OUT (C),A
...
0000FD17:	CALL FDF6h
0000FD1A:	LD A,40h
0000FD1C:	INA (01h)		; port 4001:  AY8910 PSG data port
0000FD1E:	AND 80h
0000FD20:	JP Z,FD0Eh
0000FD23:	DEC H
...
0000FD2D:	CALL FDF6h
0000FD30:	LD A,40h
0000FD32:	INA (01h)		; port 4001:  AY8910 PSG data port
0000FD34:	AND 80h
...
0000FD45:	PUSH DE
0000FD46:	PUSH HL
0000FD47:	LD BC,4000h		; port 4000: AY8910 PSG address
0000FD4A:	LD A,07h
0000FD4C:	OUT (C),A
0000FD4E:	INC C		; port 4001:  AY8910 PSG data port
0000FD4F:	LD A,BFh
0000FD51:	OUT (C),A
0000FD53:	DEC C
0000FD54:	LD A,0Eh
...
0000FD5D:	LD A,40h
0000FD5F:	INA (01h)		; port 4001:  AY8910 PSG data port
0000FD61:	AND 40h
...
0000FD86:	LD A,40h
0000FD88:	INA (01h)		; port 4001:  AY8910 PSG data port
0000FD8A:	AND 40h
0000FD8C:	JP Z,FD66h
0000FD8F:	LD A,80h
...
0000FD9E:	PUSH DE
0000FD9F:	LD D,0Ah
0000FDA1:	LD BC,4000h		; port 4000: AY8910 PSG address
0000FDA4:	LD A,0Eh
0000FDA6:	OUT (C),A
0000FDA8:	LD BC,6000h
0000FDAB:	LD A,40h
0000FDAD:	INA (01h)		; port 4001:  AY8910 PSG data port
0000FDAF:	AND 40h
0000FDB1:	JR Z,+04h
0000FDB3:	POP DE
0000FDB4:	POP BC
