...
0000624C:	RET NC
0000624D:	PUSH HL
0000624E:	LD HL,(F033h)
00006251:	INC HL
00006252:	LD (F033h),HL
00006255:	POP HL
00006256:	RET
00006257:	LD A,(F035h)
0000625A:	RLCA
...
0000625E:	RET NC
0000625F:	PUSH HL
00006260:	LD HL,(F033h)
00006263:	DEC HL
00006264:	LD (F033h),HL
00006267:	POP HL
00006268:	RET
00006269:	PUSH DE
0000626A:	LD HL,(F033h)
...
00006298:	ADD HL,DE
00006299:	LD (F033h),HL
0000629C:	POP DE
0000629D:	RET

0000629E:	LD HL,(F033h)
000062A1:	LD A,H
000062A2:	AND 3Fh
000062A4:	LD H,A
000062A5:	LD A,(F089h)
...
000063D1:	EX DE,HL
000063D2:	CALL 61CAh
000063D5:	LD HL,(F033h)
000063D8:	LD DE,0050h
000063DB:	OR A
000063DC:	SBC HL,DE
000063DE:	INC HL
000063DF:	LD (F0C3h),HL
000063E2:	LD A,(F089h)
000063E5:	LD (F0C5h),A
...
00006407:	CALL 61CAh
0000640A:	LD HL,(F033h)
0000640D:	LD (F0C8h),HL
00006410:	LD A,(F035h)
00006413:	LD (F0CBh),A
00006416:	POP AF
00006417:	LD (F035h),A
0000641A:	POP HL
0000641B:	LD (F033h),HL
0000641E:	RET
...
00006CE6:	PUSH HL
00006CE7:	PUSH AF
00006CE8:	LD HL,(F04Ch)
00006CEB:	LD A,(F04Eh)
00006CEE:	CALL 62B2h
00006CF1:	POP AF
00006CF2:	POP HL
00006CF3:	LD (F04Ch),HL
00006CF6:	LD (F04Eh),A
00006CF9:	CALL 60CCh
00006CFC:	XOR A
00006CFD:	LD (8482h),A
...
00006FDA:	AND D
00006FDB:	JP 6FCBh
00006FDE:	LD DE,(F0C0h)
00006FE2:	LD HL,(F033h)
00006FE5:	RST 20h
00006FE6:	RET C
00006FE7:	LD DE,FFB0h
00006FEA:	ADD HL,DE
00006FEB:	LD (F033h),HL
00006FEE:	OR A
00006FEF:	RET
00006FF0:	LD DE,(F0C3h)
00006FF4:	LD HL,(F033h)
00006FF7:	RST 20h
00006FF8:	CCF
00006FF9:	RET C
00006FFA:	LD DE,0050h
00006FFD:	ADD HL,DE
00006FFE:	LD (F033h),HL
00007001:	OR A
00007002:	RET
00007003:	CALL 6FDEh
00007006:	RET C
...
00007019:	OR A
0000701A:	RET
0000701B:	LD DE,(F0C0h)
0000701F:	LD HL,(F033h)
00007022:	RST 20h
...
00007030:	SCF
00007031:	RET
00007032:	LD HL,(F033h)
00007035:	LD DE,C050h
00007038:	RST 20h
00007039:	JP C,7045h
0000703C:	LD DE,FFB0h
0000703F:	ADD HL,DE
00007040:	LD (F033h),HL
00007043:	OR A
00007044:	RET
00007045:	LD A,H
00007046:	OR FEh
...
0000704A:	ADD 30h
0000704C:	LD L,A
0000704D:	LD (F033h),HL
00007050:	LD A,5Ch
00007052:	LD (F089h),A
00007055:	OR A
00007056:	RET
00007057:	LD DE,(F0C3h)
0000705B:	LD HL,(F033h)
0000705E:	RST 20h
0000705F:	JP C,706Eh
00007062:	LD A,(F0C5h)
00007065:	LD H,A
...
000070F5:	ADD HL,DE
000070F6:	LD (F0CCh),HL
000070F9:	LD HL,(F0C8h)
000070FC:	ADD HL,DE
000070FD:	LD (F0CEh),HL
00007100:	POP HL
00007101:	POP DE
00007102:	POP BC
00007103:	RET
...
000072CB:	DEC E
000072CC:	JP 72B9h
000072CF:	LD DE,(F04Fh)
000072D3:	LD HL,(F054h)
000072D6:	LD A,(F08Ah)
000072D9:	LD B,A
000072DA:	LD C,03h
000072DC:	PUSH DE
...
00007C59:	LD HL,(F033h)
00007C5C:	ADD HL,DE
00007C5D:	LD (F033h),HL
00007C60:	POP DE
00007C61:	RET
00007C62:	CALL 79AFh
00007C65:	PUSH HL
