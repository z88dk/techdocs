...
; __POWER, __DATE$, __DAY$, OUTS_B_CHARS, LINE_GFX, MAX_FN, __SOUND, MOTOR_ON,
...
; TEL_BYE, TEXT, TXT_CTL_Y, TXT_CTL_G, LOAD_BA_LBL and BOOT.
CHRGTB:
  JP _CHRGTB
...
; __LET, __LIST, PRS_M100, RAM_IO, L161B, __EOF, __LCOPY, CATALOG, KILLASC,
; __NAME, FINDCO, RESFPT, CLOADM, TSTOPL, TESTR, GSTRDE, INSTR, TSTSTR,
; _ASCTFP, INTEXP, __CLEAR, GETVAR, SCPTLP, BSERR, UPLDR, TXT_CTL_E, TXT_CTL_A,
; TXT_CTL_Z, TXT_CTL_C, MCLEAR, TXT_CTL_U, TXT_CTL_N, TXT_CTL_V, GETEND, BASIC,
; IOINIT, BOOT and __MAX.
CPDEHL:
  LD A,H
  SUB D
  RET NZ
...
; UPLDR, __MENU, PRINT_TEXT, SHOW_TIME, mycode, TXT_CTL_G and TXT_CTL_V.
OUTC:
  JP _OUTC
  NOP
...
; TSTSTR, __FIX, __INT, _ASCTFP, __NEXT, GETVAR and L4F2E.
GETYPR:
  JP _GETYPR
  NOP
...
; BCDE_FP_CMP, CMP_HLDE, __FIX and PUFOUT.
TSTSGN:
  JP _TSTSGN
  NOP
...
; for VECT_TBL
;
; Used by the routines at CHGET, CHSNS, LPT_OUT, CRT_OPN, CRT_OUTPUT, __EOF,
...
; L5123, TELCOM_RDY, TEL_TERM, UPLDR, TXT_ESC and FONT.
RST38H:
  JP _RST38H
  NOP
...
; EVAL3, IDERR, __POWER, __DATE$, __DAY$, KEY_STMTS, __KILL, OPENDO, CSAVEM,
...
; GETINT, GETWORD, __DAY$, OUTS_B_CHARS, STRING_S, INSTR, USING and FNAME.
EVAL:
  DEC HL
...
;
; Used by the routines at SETSER, __DAY$, FNAME, DSKI_S, FIND_TEXT and
; LOAD_BA_LBL.
UCASE_HL:
  LD A,(HL)
...
;
; Used by the routines at __DAY$, TEL_SET_STAT, TEL_BYE, FIND_TEXT, IS_CRLF and
; CHGET_UCASE.
UCASE:
  CP $61
  RET C
...
; __DATE$, __MDM, OUTS_B_CHARS, LINE_GFX, __SOUND, __CALL, __SCREEN, INSTR,
...
; IS_CRLF, CHGET_UCASE, WAIT_SPC, MCLEAR, TXT_CTL_N and mycode.
CHGET:
  PUSH HL
  PUSH DE
  PUSH BC
...
RAM_CLS:
  ...
  LD (HL),$00
  JP _CLOSE
; This entry point is used by the routine at L161B.
RAM_CLS_0:
  INC HL
  INC HL
  LD A,(HL)
...
L161B_2:
  ...
  CALL RAM_CLS_0
  JP CHKSTK_0
; This entry point is used by the routines at RAM_OPN, RAM_CLS, RAM_IO and
; __EOF.
L161B_3:
  PUSH DE
  LD HL,($FAA2)
...
COM_IO:
  LD HL,$FA8F
; This entry point is used by the routines at L161B and CAS_INPUT.
COM_IO_0:
  LD (HL),C
  JP L4F2E_15
...
__EOF_3:
  LD BC,$0001
; This entry point is used by the routines at L161B and KILLASC.
__EOF_4:
  LD HL,($FB9D)
__EOF_5:
  LD A,(HL)
...
;
; Used by the routines at READ_TIME, L192F, L1962 and __DAY$.
READ_CLOCK:
  PUSH HL
  LD HL,SECS
  DI
...
;
; Used by the routines at __DATE$ and __DAY$.
SET_CLOCK:
  LD HL,SECS
  DI
  CALL SET_CLOCK_HL
...
__DAY$_2:
  ...
  JP NZ,__DAY$_0
  JP SNERR
; This entry point is used by the routine at __DATE$.
__DAY$_3:
  RST $08
  DEFB $DD
...
__DAY$_4:
  ...
  CP $08
  RET
; This entry point is used by the routines at __TIME$ and ON_TIME_S.
__DAY$_5:
  CALL __DAY$_3
  JP NZ,SNERR
  EX DE,HL
...
__MDM:
  ...
  LD HL,ON_COM_FLG
  JP __MDM_1
; This entry point is used by the routine at __TIME$.
__MDM_0:
  PUSH HL
  LD HL,ON_TIME_FLG
__MDM_1:
...
LINE_GFX_13:
  ...
  LD D,A
  EX DE,HL
; This entry point is used by the routines at INLIN and mycode.
LINE_GFX_14:
  LD (GR_X),HL
  EX DE,HL
  LD A,(HL)
...
; Routine at 8518
;
; Used by the routines at CHGET, RAM_OPN, RAM_IO, L161B, __LCOPY, SAVEBA,
; __KILL, KILLASC, __NEW, MAKTXT, SWAPNM, CSAVEM, CLOADM, UPLDR, TEL_DOWN,
; __MENU, __EDIT and TXT_CTL_U.
RESFPT:
  XOR A
  LD ($F809),A
  LD HL,($FAC0)
...
; Create String
;
; Used by the routines at __PRINT, __STR$ and PRS.
CRTST:
  DEC HL
...
;
; Used by the routines at __DAY$, OUTS_B_CHARS, CAS_OPNI_CO, __LEN, INSTR and
; FNAME.
GETSTR:
  CALL TSTSTR
...
;
; Used by the routines at __STR$, PRS1 and __FRE.
GSTRCU:
  LD HL,(DBL_FPREG)
...
L31B8:
  LD DE,FAC2
; This entry point is used by the routine at L31C4.
L31B8_0:
  EX DE,HL
  CALL L31CA_0
  EX DE,HL
...
L31CA:
  LD DE,FACCU
; This entry point is used by the routines at __RND and L31B8.
L31CA_0:
  LD B,$08
  JP REV_LDIR_B
...
POP_FAC1_1:
  ...
  EX AF,AF'
  LD HL,$2100
; This entry point is used by the routine at FP_EPSILON.
POP_FAC1_2:
  INC DE
  INC H
  ADD A,(HL)
...
;
; Used by the routines at EVAL3, L0F0D, IADD and INT_MUL.
STAKFP:
  EX DE,HL
  LD HL,(DBL_FPREG)
  EX (SP),HL
...
;
; Used by the routines at EVAL3, L0F0D, __LOG, __RND, IADD, INT_MUL and INTEXP.
HL_CSNG:
  LD A,H
; This entry point is used by the routine at DBL_ABS.
HL_CSNG_0:
...
FMULT:
  CALL __CDBL_0
  JP DECMUL
; This entry point is used by the routine at L0F0D.
FMULT_0:
  POP BC
  POP DE
...
;
; Used by the routines at __PRINT, __STR$ and PUFOUT.
FOUT:
  XOR A
...
CHKSTK:
  ...
  POP HL
  RET C
; This entry point is used by the routines at L161B, MAKTXT, CSAVEM, __CLOAD,
...
;
; Used by the routines at CAS_OPNI_CO, ERAFNK, DSPFNK, INXD, mycode and
; TXT_CTL_V.
ERAEOL:
  LD A,$4B
  JP ESCA
...
; TXT_CTL_C, MCLEAR, mycode, TXT_CTL_Y and TXT_CTL_V.
POSIT:
  LD A,$59
  CALL ESCA
  LD A,L
...
OUTC_SUB2:
  LD HL,$4388
  LD C,$08
; This entry point is used by the routines at IN_ESC, INLIN and mycode.
OUTC_SUB2_0:
  INC HL
  INC HL
  DEC C
...
;
; Used by the routines at INLIN, INLIN_CTL_UX and mycode.
INLIN_CURS:
  LD A,B
  DEC A
  SCF
...
;
; Used by the routines at COM_OPN, L17DB, TEL_LOGON and TEL_BYE.
TEL_DISC:
  CALL TEL_CONN_0
  CALL TEL_LOGON_0
...
; Routine at 21270
;
; Used by the routines at COM_OPN, L17DB, TEL_LIFT, TEL_LOGON and TEL_DIAL_DGT.
TMDELA:
  DEC A
  JP NZ,TEL_PAUSE_0
...
TXT_CTL_I_1:
  ...
  LD HL,ERR_MEMORY
  CALL TXT_CTL_N_5
; This entry point is used by the routines at TXT_CTL_C, TXT_CTL_N and mycode.
TXT_CTL_I_2:
  POP HL
  JP POSIT
...
; TXT_CTL_B, TXT_CTL_Z, TXT_CTL_L, TXT_CTL_C, TXT_CTL_U, TXT_CTL_N, mycode and
; TXT_CTL_V.
MCLEAR_6:
  PUSH HL
  PUSH AF
  ...
  POP HL
  RET
; This entry point is used by the routines at TXT_ESC, TXT_CTL_C, mycode and
; TXT_CTL_V.
MCLEAR_7:
  PUSH AF
  LD HL,(ACTV_X)
...
TXT_CTL_N_5:
  LD A,$01
  LD ($F6E1),A
; This entry point is used by the routine at mycode.
TXT_CTL_N_6:
  CALL mycode
  CALL PRS
; This entry point is used by the routine at WAIT_SPC.
...
;
; Used by the routines at TXT_CTL_N, mycode and TXT_CTL_Y.
MOVE_TEXT:
  PUSH HL
MOVE_TEXT_0:
  LD A,(HL)
...
;
; Used by the routines at L161B, CSAVEM, __CLOAD, TXT_CTL_U and INSCHR.
MAKHOL:
  EX DE,HL
  LD HL,(ARREND)
  ADD HL,BC
