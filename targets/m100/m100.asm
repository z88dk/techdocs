; TANDY M100 / Kyotronic KC85  disassembly
...
FREEMEM_1:
  ...
  JP NZ,FREEMEM_1
IF KC85
  LD B,18		; 18*2 = 36 words initialized with 'FCERR'
ENDIF
IF M100
  LD B,19		; 19*2 = 38 words initialized with 'FCERR'
ENDIF
  LD DE,FCERR	; 
  DEC C
  JP NZ,FREEMEM_1
