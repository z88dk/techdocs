...
; A=(HL), HL++, skip spaces
;
; Used by the routines at L0493, EXEC_HL, TOKENIZE, STEP, EXEC, __DEF, DECLVAR,
...
__LET_3:
  ...
  RST CPDEHL
  JP C,__LET_4
  LD HL,$FB6A		; Guessing..  TMPSTR ?  unknown system variable address, but on SpectraVideo it is still one byte less than DSCTMP !
  RST CPDEHL
  JP C,MVSTPT
__LET_4:
  ;LD A,$D1
...
L1072:
  ...
  CP $7B
  JP Z,INT_DIV
  LD BC,L10D3  ; Routine location to toad the integer into FAC1.
  PUSH BC
  CP $46
  JP NZ,OR_0
...
; This table in the TRS80 Model 100 is different
; than the one in MSX (above)

  DEFB $08	; 8 values
  DEFB $bf,$52,$08,$69,$39,$04,$00,$00
  DEFB $3f,$75,$30,$71,$49,$13,$48,$00
  DEFB $bf,$90,$81,$34,$32,$24,$70,$50
  DEFB $40,$11,$11,$07,$94,$18,$40,$29
  DEFB $c0,$14,$28,$56,$08,$55,$48,$84
  DEFB $40,$19,$99,$99,$99,$94,$89,$67
  DEFB $c0,$33,$33,$33,$33,$33,$31,$60
  DEFB $41,$10,$00,$00,$00,$00,$00,$00
...
DSPFNK_1:
  LD A,(ACTV_Y)
  CP 40
  LD BC,$040C		; range for 40 columns
  JP Z,DSPFNK_2
  LD BC,$0907		; range
DSPFNK_2:
  PUSH HL
...
; Routine at 26041
;
; Used by the routine at WAIT_SPC_1.
L65B9:
  CALL CHSNS
  RET Z
  CALL CHGET
...
L746A:
  LD HL,L764D ; watch out: L764D <> L746D !
...
INIT_HOOKS:
  LD HL,RST38_VECT
  LD BC,$1D02	; B=29, C=2
  LD DE,NULSUB	; 39 words initialized with NULSUB
FREEMEM_1:
  LD (HL),E
  INC HL
  LD (HL),D
