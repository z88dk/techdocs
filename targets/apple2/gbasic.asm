...
# defc TK_TRON     =  $9F
# defc TK_TROFF    =  $A0	; Token for 'TROFF'
# defc TK_SWAP     =  $A1
# defc TK_ERASE    =  $A2
# defc TK_EDIT     =  $A3
...
OPTFLG:
  DEFB $00,$E1,$D1,$F1,$F5,$D5,$E9,$2A
  DEFB $5E,$0B,$F9,$D5,$0E,$0E,$C3,$8B
  DEFB $4B,$00,$00,$00,$00,$00,$00,$00
...
; Routine at 3325
;
; Used by the routines at __POP, __RETURN and ISLETTER_A.
BAKSTK:
  LD HL,$0004
  ADD HL,SP
...
; Routine at 3329
;
; Used by the routines at INDFND and BAKSP.
LOKFOR:
  LD A,(HL)
  INC HL
  CP $AF
...
; Routine at 3399
;
; Used by the routines at FILGET, OKGETM, __CLOSE, FN_INPUT, __EOF, __OPEN and
; __GET.
FMODE_ERR:
  LD E,$36
...
; Routine at 3402
;
; Used by the routines at __NAME and __OPEN.
FF_ERR:
  LD E,$35
...
; Routine at 3405
;
; Used by the routines at FILID2, __CLOSE, __EOF, __LOC, __LOF and __OPEN.
BN_ERR:
  LD E,$34
...
; Routine at 3411
;
; Used by the routines at __CVD and DSKCHR.
EF_ERR:
  LD E,$3E
...
; Routine at 3423
;
; Used by the routines at __CLOSE and __GET.
FO_ERR:
  LD E,$32
...
; Routine at 3426
;
; Used by the routines at __EOF and __OPEN.
FL_ERR:
  LD E,$43
...
; entry for '?SN ERROR'
;
; Used by the routines at LNUM_RANGE, FORFND, NEWSTT, __AUTO, SCNSTR, __INPUT,
; LOPREL, OCTCNS, FINASG, IDTEST, GETWORD_HL, DEPTR, PTRGET, __USING, SYNCHR,
; ISLETTER_A, PINLIN, __CHAIN, __LOAD, __MERGE, __GET and PROCHK.
SN_ERR:
  LD E,$02
...
;
; Used by the routine at ISLETTER_A.
NF_ERR:
  LD E,$01
...
;
; Used by the routines at DEPTR and PTRGET.
DD_ERR:
  LD E,$0A
...
; OVERFLOW ERROR
;
; Used by the routines at OCTCNS, __CINT, FINEC and ISLETTER_A.
OV_ERR:
  LD E,$06
...
; TYPE MISMATCH ERROR
;
; Used by the routines at FORFND, EVAL_NUMERIC, EVAL1, INVSGN, VSIGN, __CINT,
; __CSNG, HLPASS, TSTSTR, __INT and __NOTRACE.
TM_ERR:
  LD E,$0D

; Routine at 3465
;
; Used by the routines at PRG_END, FILE_EXISTS_ERR, KRNSAV, DEFCON, UL_ERR,
; __RETURN, RESTXT, FDTLP, IDTEST, DEPTR, __PDL, PTRGET, OM_ERR, __CONT,
; TSTOPL, TESTR, CONCAT, PINLIN and DIRDO.
ERROR:
  LD HL,(CURLIN)
  LD (ERRLIN),HL
  XOR A
...
; Routine at 3486
;
; Used by the routines at ERROR and __ON.
ERRESM:
  LD BC,ERRMOR
...
RESTART:
  POP BC
; This entry point is used by the routines at PROMPT, __LIST, EDITRT, NOTRNL
; and PROCHK.
RESTART_0:
  CALL OUTDO_7
  XOR A
...
; Routine at 3646
;
; Used by the routines at AUTSTR, GETCMD, FINI, __AUTO, NOTRNL, OKGETM and
; MAINGO.
PROMPT:
  LD HL,$FFFF
  LD (CURLIN),HL
...
; Routine at 3897
;
; Used by the routines at CDVARS and NOTRNL.
LINKER:
  LD HL,(TXTTAB)
  EX DE,HL
...
;
; Used by the routines at __LIST, TSTANM and __CHAIN.
LNUM_RANGE:
  LD DE,$0000
  PUSH DE
  JR Z,LNUM_RANGE_1
...
; Routine at 3976
;
; Used by the routines at PROMPT, EDENT, __GOTO, TSTANM, GETWORD_HL, PTRGET,
; __RESTORE, __CHAIN and CDVARS.
SRCHLN:
  LD HL,(TXTTAB)
...
FORFND_2:
  ...
  PUSH AF
  JP $6AD4
; This entry point is used by the routine at ISLETTER_A.
FORFND_3:
  LD B,$82
  PUSH BC
  INC SP
...
; Routine at 13163
;
; Used by the routines at __POP, ISLETTER_A, PINLIN, CDVARS and NOTRNL.
NEWSTT:
  PUSH HL
  CALL $0000
  POP HL
...
NEWSTT_2:
  ...
  PUSH DE
  RET Z
; This entry point is used by the routines at __ON and __AUTO.
NEWSTT_3:
  SUB $81
  JP C,__LET
  CP $5B
...
; NEWSTT, _CHRCKB, DEFCON, ATOH, __REM, __ON, RESNXT, __AUTO, __PRINT, __TAB,
; NEXITM, __INPUT, __READ, FDTLP, LOPREL, OPRND, __ERR, __ERL, __VARPTR,
; OCTCNS, PASSA, FINASG, __WIDTH, FPSINT, FNDNUM, CONINT, TSTANM, GETWORD_HL,
; DEPTR, __PDL, FIN, DPOINT, FOUTZS, FOUTTS, SUMLP, DIMRET, PTRGET, __USING,
; L670C, __NOTRACE, ISLETTER_A, DTSTR, TOPOOL, __VAL, __INSTR, PINLIN, __CHAIN,
; CHAIN_COMMON, BCKUCM, CDVARS, FILSCN, __CVD, __LOAD, __MERGE, __SAVE,
; __CLOSE, FN_INPUT, __OPEN, __GET and PROCHK.
CHRGTB:
  INC HL

; Pick current char (or token) on program
;
; Used by the routines at CHEAD, SRCHLP and __PDL.
_CHRCKB:
  LD A,(HL)
  CP $3A
  RET NC
...
_CHRCKB_1:
  CP $10
  JR NZ,_CHRCKB_3
; This entry point is used by the routines at _CONFAC, NEW_STMT and CONFDB.
_CHRCKB_2:
  LD HL,(CONTXT)
  JR _CHRCKB
_CHRCKB_3:
...
; Routine at 13435
;
; Used by the routine at _CONFAC.
CONFDB:
  LD HL,CONLO
  CALL VMOVE_3
  JP _CHRCKB_2
...
DEFCON_1:
  ...
  CALL CHRGTB
  JR DEFCON
; This entry point is used by the routines at PTRGET, __OPEN and __GET.
DEFCON_2:
  CALL CHRGTB
; This entry point is used by the routine at ISLETTER_A.
DEFCON_3:
  CALL POSINT
  RET P
; This entry point is used by the routines at SRCHLP, RESTXT, __AUTO, __VARPTR,
; LPSIZL, CONINT, TSTANM, GETWORD_HL, __VTAB, __COLOR, __PDL, __LOG, __USING,
; __NOTRACE, ISLETTER_A, __ASC, __MID_S, __INSTR, __CHAIN, CHAIN_COMMON,
; SCNSMP, __CVD, FN_INPUT, __NAME, __OPEN, __GET and PROCHK.
FC_ERR:
  LD E,$05
  JP ERROR
; This entry point is used by the routines at LNUM_RANGE, __AUTO, GETWORD_HL
; and PTRGET.
LNUM_PARM:
  LD A,(HL)
  CP $2E
...
;
; Used by the routines at GETCMD, NUMTRY, __GOSUB, __GOTO, __ON, __RESUME,
; __AUTO, UCASE, GETWORD_HL, __RESTORE and PINLIN.
ATOH:
  DEC HL
; This entry point is used by the routine at __ON.
ATOH_0:
  ...
  JP Z,ATOH_1
  CP $0D
; This entry point is used by the routine at GETWORD_HL.
ATOH_1:
  EX DE,HL
  LD HL,(CONLO)
  EX DE,HL
...
; entry for '?UL ERROR'
;
; Used by the routines at EDENT, __GOTO, __ON, PTRGET, __RESTORE and CDVARS.
UL_ERR:
  LD E,$08
  JP ERROR
...
; Routine at 13748
;
; Used by the routines at BAKSP, RESTXT, __AUTO, FDTLP, PASSA, __CHAIN and
; CDVARS.
__DATA:
  LD BC,$0E3A
...
; Routine at 14463
;
; Used by the routines at __PRINT, __READ, __USING, RUN_FST, NTRNDW, LOAD_END,
; PUTCHR and __LOF.
FINPRT:
  XOR A
  LD (PRTFLG),A
...
; Routine at 14954
;
; Used by the routines at FINASG, __INSTR and __LSET.
FRMEQL:
  CALL SYNCHR
  RET P
  JP EVAL
...
; Routine at 14961
;
; Used by the routines at __VARPTR, OCTCNS and __INSTR.
OPNPAR:
  CALL SYNCHR
  JR Z,$3AA1
...
; Routine at 14965
;
; Used by the routines at SRCHLP, BAKSP, FORFND, __REM, __AUTO, __PRINT,
; FRMEQL, ASGMOR, POSINT, GETINT, __POKE, DEPTR, __USING, ISLETTER_A, TOPOOL,
; __INSTR, PINLIN, __CHAIN, CDVARS, FILSCN, FNAME and __OPEN.
EVAL:
  DEC HL
...
__VARPTR_3:
  ...
  CP $E2
  JP Z,PASSA_7
; This entry point is used by the routines at OCTCNS and PASSA.
__VARPTR_4:
  CALL OPNPAR
  CALL SYNCHR
  ADD HL,HL
...
; __CSNG, HLPASS, TSTSTR, __FIX, __INT, FINE, DPOINT, MULTEN, FINDIV, ADDIG,
; FINEDG, OVERR, FINEC, DOEBIT, FOUTNV, FOUTCV, PTRGET, __NOTRACE, TOPOOL,
; __INSTR, __FRE, PINLIN, CDVARS and __CVD.
GETYPR:
  LD A,(VALTYP)
  CP $08
  JR NC,GETYPR_0
...
;
; Used by the routines at __ERR, __PEEK, __VPOS, __PDL, __VAL and __LOF.
PASSA:
  LD L,A
  XOR A
...
; Routine at 16383
;
; Used by the routines at BAKSP, __REM, ASGMOR and __MKD_S.
CHKTYP:
  PUSH HL
  AND $07
  LD HL,TYPE_OPR
...
; Routine at 16403
;
; Used by the routines at LPSIZL, FINASG and NOCPRS.
BCTRAN:
  LD A,B
  OR C
  JR NZ,BCTRAL
...
;
; Used by the routines at DEFCON, __TAB, PASSA, __WAIT and __PDL.
POSINT:
  CALL EVAL
...
;
; Used by the routines at __VARPTR and __CLOSE.
FNDNUM:
  CALL CHRGTB

; Routine at 16535
;
; Used by the routines at __ON, RESTXT, OCTCNS, __WIDTH, __POKE, __VTAB,
; __NORMAL, __COLOR, __VLIN, __WAIT, __PDL, __INSTR, __CLOSE and __OPEN.
GETINT:
  CALL EVAL

; Routine at 16538
;
; Used by the routines at __BUTTON, __PDL, __ASC, TOPOOL, __SPACE_S, __INSTR
; and FILFRM.
CONINT:
  CALL DEPINT
  JP NZ,FC_ERR
...
; Routine at 16649
;
; Used by the routines at __LIST and PTRGET.
DETOKEN_LIST:
  LD BC,BUF
  LD D,$FF
  XOR A
...
; Routine at 17094
;
; Used by the routines at __PEEK, __POKE, FOUTH, ISLETTER_A and __CHAIN.
GETWORD_HL:
  LD BC,__CINT
  PUSH BC
  CALL GETYPR
...
; Routine at 17419
;
; Used by the routines at LINFND, TSTANM and __CHAIN.
DEPTR:
  LD A,(PTRFLG)
  OR A
  RET Z
...
__OPTION:
  ...
  CALL CHRGTB
  RET
; This entry point is used by the routines at GETWORD_HL and FINEC.
DEPTR_0:
  LD A,(HL)
  OR A
  RET Z
...
__NORMAL_0:
  ...
  LD ($4B96),A
  JR __VTAB_8
; This entry point is used by the routines at __PLOT and __PDL.
__NORMAL_1:
  LD (A2_COLOR_0),HL
  LD ($0000),A
  RET
...
__NORMAL_3:
  ...
  POP HL
  RET
; This entry point is used by the routine at __COLOR.
__NORMAL_4:
  LD HL,$F819
  JP __NORMAL_1
...
__COLOR_0:
  ...
  LD (A2_COLOR),A
  RET
; This entry point is used by the routine at __VLIN.
__COLOR_1:
  PUSH BC
  CALL __VLIN_0
  POP BC
  CP B
; This entry point is used by the routines at __NORMAL and __VLIN.
__COLOR_2:
  JP NC,FC_ERR
  CP E
  JP C,FC_ERR
...
__VLIN_0:
  ...
  POP DE
  RET
; This entry point is used by the routine at __PLOT.
__VLIN_1:
  CALL __VLIN_0
  CP $30
  JR NC,__COLOR_2
...
__PLOT:
  ...
  PUSH HL
  LD HL,$F800
; This entry point is used by the routines at __VLIN, __BEEP and __PDL.
__PLOT_0:
  CALL __NORMAL_1
  POP HL
  RET
...
;
; Used by the routines at GETWORD_HL, __PDL, __LOG, MLSP10, FINDG4, SUMLP and
; __SIN.
FADD:
  LD A,B
  OR A
...
FMULT_2:
  ...
  JR NZ,FMULT_0
  EX DE,HL
; This entry point is used by the routines at FDIV, PTRGET, DISPED and L670C.
FMULT_3:
  POP HL
  RET
FMULT_4:
...
; Test sign of FPREG
;
; Used by the routines at FORFND, __LOG, FMULT, FDIV, VSIGN, FCOMP, __FIX,
; DMUL, FFXSDC, FFXXVS, POWER, __RND, __SIN and __ATN.
SIGN:
  LD A,(FPEXP)
  OR A
  RET Z
  LD A,($0CB3)
  CP $2F
; This entry point is used by the routines at VSIGN and FCOMP.
SIGN_0:
  RLA
; This entry point is used by the routines at FCOMP and ISLETTER_A.
SIGN_1:
  SBC A,A
  RET NZ
  INC A
...
; Test sign in number
;
; Used by the routines at __AUTO, __ABS, __SGN, PUFOUT and PINLIN.
VSIGN:
  CALL GETYPR
  JP Z,TM_ERR
  JP P,SIGN
...
;
; Used by the routines at DIV10, FOUCD1, __SQR, POLY, SUMLP, __RND and
; ISLETTER_A.
MOVFM:
  CALL LOADFP
...
; Move BCDE to FPREG
;
; Used by the routines at EVAL1, FADD, __LOG, FOUFRV, FOUCD1, FOUCS1, GET_UNITY
; and __TAN.
FPBCDE:
  EX DE,HL
  LD (FACCU),HL
...
; Load FP reg to BCDE
;
; Used by the routines at FORFND, EVAL_FP, __LOG, MLSP10, __CSNG, QINT, INT,
...
;
; Used by the routines at __PDL, MOVFM, SUMLP, __RND and ISLETTER_A.
LOADFP:
  LD E,(HL)
  INC HL
...
L4EBF:
  INC HL
  RET
; This entry point is used by the routines at BAKSP, __RND and ISLETTER_A.
L4EBF_0:
  LD DE,FACCU
...
; Routine at 20169
;
; Used by the routines at __REM, FCOMP, DMUL, FOUTNV, __NOTRACE, TSTOPL and
; __INSTR.
VMOVE:
  LD A,(VALTYP)
  LD B,A
...
VMOVE_0:
  ...
  DJNZ VMOVE_0
  RET
; This entry point is used by the routines at FADD, FDIV, __CSNG, QINT, INT and
; DADD.
VMOVE_1:
  LD HL,$0CB3
  LD A,(HL)
...
VMOVE_2:
  LD HL,$0CBA
; This entry point is used by the routines at CONFDB, EVAL_VARIABLE, POPASG,
; __CINT, FOUTCV, PINLIN and __CVD.
VMOVE_3:
  LD DE,$4EC8
  JR VMOVAF_1
...
; Routine at 20209
;
; Used by the routines at EVAL1, __CINT, DMUL10, FINDGE and FOUTCV.
VMOVAF:
  LD HL,$0CBA
; This entry point is used by the routines at ASGMOR and __MKD_S.
VMOVAF_0:
  LD DE,VMOVE
; This entry point is used by the routine at VMOVE.
VMOVAF_1:
  PUSH DE
  LD DE,FACCU
  CALL GETYPR
...
;
; Used by the routines at MAKINT, FINDGE, FFXSFX, FOUTNV, POWER, __SIN and
; ISLETTER_A.
FCOMP:
  LD A,B
  OR A
...
FCOMP_2:
  ...
  JP NZ,SIGN_1
  RET
; This entry point is used by the routines at FOUFXV and FOUTNV.
FCOMP_3:
  LD HL,$0CBA
  CALL VMOVE
; This entry point is used by the routine at DCOMP.
FCOMP_4:
  LD DE,$0CC1
  LD A,(DE)
  OR A
...
; Routine at 20342
;
; Used by the routines at FORFND, LOPREL, __NOT, GETYPR, DEPINT, DEPTR and
; PINLIN.
__CINT:
  CALL GETYPR
  LD HL,(FACCU)
...
;
; Used by the routines at __VARPTR, OCTCNS, PASSA, __BUTTON, CONIA, __CINT,
; INT, IMULT, INEGA, INEGHL, FIN and LINPRT.
MAKINT:
  LD (FACCU),HL
...
; Routine at 20462
;
; Used by the routines at FORFND, LOPREL, EVAL1, OCTCNS, DPOINT and POWER.
__CSNG:
  CALL GETYPR
  RET PO
  JP M,__CSNG_1
...
__CSNG_0:
  ...
  LD B,(HL)
  JP FADD_12
; This entry point is used by the routines at HLPASS, FINDGE and FFXXVS.
__CSNG_1:
  LD HL,(FACCU)
...
HLPASS:
  ...
  LD B,$90
  JP FLOAT_0
; This entry point is used by the routines at EVAL1, INT and DPOINT.
__CDBL:
  CALL GETYPR
  RET NC
  JP Z,TM_ERR
...
;
; Used by the routines at __LINE, OCTCNS, __USING, CONCAT, GETSTR, __INSTR,
; __CVD, __CLOSE and __LSET.
TSTSTR:
  CALL GETYPR
  RET Z
  JP TM_ERR
...
IMULT_4:
  ...
  POP DE
  JP NEG
; This entry point is used by the routines at GETYPR and INEG.
IMULT_5:
  LD A,H
  OR L
  JP Z,O_ERR
...
INEG:
  ...
  OR L
  RET NZ
; This entry point is used by the routines at _CONFAC, __ERL and GETYPR.
INEG_0:
  EX DE,HL
  CALL VALSNG
  XOR A
...
INEG_1:
  LD B,$98
  JP FLOAT_0
; This entry point is used by the routines at LPTMDF and GETYPR.
INEG_2:
  PUSH DE
  CALL IMULT_5
  XOR A
...
DMUL10:
  ...
  RET NZ
  JP OVERR_1
; This entry point is used by the routines at __READ, __VAL and __CVD.
DMUL10_0:
  CALL FADD_5
  CALL HLPASS_1
  OR $AF
...
; Routine at 21671
;
; Used by the routines at FLTGET, __READ, OPRND, DEPTR and __CVD.
FIN:
  XOR A
  LD BC,$4531
  PUSH BC
...
; Routine at 21908
;
; Used by the routines at FINE, FFXXVS and FOUTNV.
FINDIV:
  PUSH DE
  PUSH HL
  PUSH AF
...
; Routine at 22283
;
; Used by the routines at ERRMOR and GETWORD_HL.
IN_PRT:
  PUSH HL
  LD HL,IN_MSG
  CALL PRS
...
;
; Used by the routines at PROMPT, NEWSTT, __LIST, GETWORD_HL, PTRGET and
; PROCHK.
LINPRT:
  LD BC,PRNUMS
  PUSH BC
...
;
; Used by the routines at __PRINT, TSTANM, FFXSDO, __STR_S and CDVARS.
FOUT:
  XOR A
...
FOUTNV_9:
  ...
  JP P,FOUTNV_5
  JP (HL)
; This entry point is used by the routines at FOUTFX, FOUTTD, FFXSDC and
; FFXXVS.
FOUTNV_10:
  OR A
FOUTNV_11:
...
FOUTNV_13:
  RET Z
  CALL FOUTED
; This entry point is used by the routine at FFXSDC.
FOUTNV_14:
  LD (HL),$30
  INC HL
  DEC A
  JR FOUTNV_13
; This entry point is used by the routines at FFXSDC and FFXXVS.
FOUTNV_15:
  LD A,E
  ADD A,D
  INC A
...
FOUTNV_17:
  ...
  LD C,A
  RET
; This entry point is used by the routine at FOUFRF.
FOUTNV_18:
  DEC B
  JP P,FOUTED_0
  LD (NXTOPR),HL
...
; Routine at 23270
;
; Used by the routines at FFXSDC, FFXXVS, FOUTNV, FOUCD1, FOUCS1 and FOUTCI.
FOUTED:
  DEC B
; This entry point is used by the routine at FOUTNV.
FOUTED_0:
  JR NZ,FOUED1
...
; Routine at 23614
;
; Used by the routines at TSTANM and ISLETTER_A.
FOUTO:
  XOR A
  LD B,A
  JP NZ,$0106
...
SUMLP_0:
  CALL CHRGTB
; This entry point is used by the routine at DEPTR.
SUMLP_1:
  PUSH HL
  LD HL,FP_UNITY
  CALL MOVFM
...
;
; Used by the routines at SRCHLP, BAKSP, __REM, __LINE, __INPUT, __READ,
; __VARPTR, EVAL_VARIABLE, PASSA, ASGMOR, DEPTR, __NOTRACE, ISLETTER_A, PINLIN,
; CHAIN_COMMON, SCNSMP, __CVD, __CLOSE and __LSET.
PTRGET:
  XOR A
  LD ($0B13),A
  LD C,(HL)
; This entry point is used by the routine at IDTEST.
PTRGET_0:
  CALL CHKLTR
  JP C,SN_ERR
  XOR A
...
PTRGET_43:
  ...
  POP HL
  RET
; This entry point is used by the routines at TESTR, CLPSLP, CLPAKP and DNCMDA.
PTRGET_44:
  LD A,(HL)
  INC HL
PTRGET_45:
...
;
; Used by the routines at PROMPT, NEWSTT, SPCLP, __INPUT, __LIST, PTRGET,
; DISPED, __USING, NTBKS1, L670C, OUTCH1, ENDCON, PRS1, __FRE, PINLIN, CDVARS,
; CRLFSQ and __OPEN.
OUTDO:
  PUSH AF
  PUSH HL
...
L670C_5:
  ...
  XOR A
  RET
; This entry point is used by the routines at ERRMOR, RESTART, GETWORD_HL and
; ENDCON.
L670C_6:
  LD A,(TTYPOS)
  OR A
...
; DISPED, __USING, NOTAB, ENDCON, PINLIN, NTRNDW, __OPEN and PROCHK.
L670C_8:
  LD A,$0D
  CALL OUTDO
  LD A,$0A
...
OUTCH1:
  ...
  LD A,$0A
  RET
; This entry point is used by the routines at LEVFRE and PTRGET.
OUTCH1_0:
  CALL OM_ERR_1
; This entry point is used by the routines at DISPED, TESTR and CDVARS.
OUTCH1_1:
  PUSH BC
  EX (SP),HL
  POP BC
...
;
; Used by the routines at FORFND, __GOSUB, EVAL, ASGMOR, FINASG, PTRGET and
; PINLIN.
CHKSTK:
  PUSH HL
  LD HL,(MEMSIZ)
...
; Routine at 26678
;
; Used by the routines at PTRGET, CHKSTK, ISLETTER_A, LOAD_END and PROCHK.
OM_ERR:
  LD HL,(STKTOP)
  DEC HL
  DEC HL
...
OM_ERR_0:
  LD DE,$0007
  JP ERROR
; This entry point is used by the routines at PTRGET, OUTCH1 and PROCHK.
OM_ERR_1:
  CALL OM_ERR_2
  RET NC
  PUSH BC
...
; Routine at 26743
;
; Used by the routines at NOTRNL and LOAD_END.
CLRPTR:
  LD HL,(TXTTAB)
  CALL __NOTRACE
  LD (PROFLG),A
...
; Routine at 26765
;
; Used by the routines at FINI, __RUN, L670C and NOTRNL.
RUN_FST:
  LD HL,(TXTTAB)
  DEC HL
; This entry point is used by the routines at __RUN and ISLETTER_A.
RUN_FST_0:
  LD (TEMP),HL
  LD A,(MRGFLG)
  OR A
...
; Routine at 26907
;
; Used by the routines at LOAD_END, __OPEN and __GET.
GTMPRT:
  LD HL,(TEMP)
  RET
...
;
; Used by the routines at LOKFOR, ERRMOR, AUTGOD, SRCHLP, BAKSP, ATOH, __GOTO,
; __REM, FINASG, __LIST, TSTANM, GETWORD_HL, DEPTR, ADDIG, FINEC, PTRGET,
; OUTCH1, OM_ERR, __NOTRACE, ISLETTER_A, TSTOPL, TESTR, GSTRDE, __INSTR,
; PINLIN, __CHAIN, CLPSLP, DLSVLP, CLPAKP, DNCMDA, CAYSTR, CDVARS, BINSAV,
; __CLOSE, __LSET, __OPEN and __GET.
DCOMPR:
  LD A,H
  SUB D
  RET NZ
...
;
; Used by the routines at BAKSP, FORFND, __REM, __ON, __AUTO, LNOMOD, __LINE,
; __INPUT, __READ, FRMEQL, OPNPAR, __VARPTR, OCTCNS, PASSA, ASGMOR, FINASG,
; IDTEST, __POKE, GETWORD_HL, DEPTR, __COLOR, __VLIN, __WAIT, __PDL, DIMRET,
; __USING, __NOTRACE, ISLETTER_A, TOPOOL, LFRGNM, __INSTR, PINLIN, __CHAIN,
; BCKUCM, CDVARS, GDFILM, __LOAD, __SAVE, __CLOSE, FN_INPUT, __NAME, __OPEN and
; PROCHK.
SYNCHR:
  LD A,(HL)
  EX (SP),HL
...
ENDCON_1:
  LD A,$0F
; This entry point is used by the routines at L670C and PINLIN.
ENDCON_2:
  PUSH AF
  SUB $03
  JR NZ,ENDCON_3
...
__STR_S:
  CALL FOUT
; This entry point is used by the routines at ISLETTER_A and __HEX_S.
__STR_S_0:
  CALL CRTST
  CALL GSTRCU
...
; Routine at 27590
;
; Used by the routines at __REM, FINASG, __INSTR and CDVARS.
STRCPY:
  LD A,(HL)
  INC HL
  PUSH HL
...
;
; Used by the routines at CONCAT, __SPACE_S, __MKD_S, MAKDSC and FN_INPUT.
MKTMST:
  CALL TESTR
...
; Create String
;
; Used by the routines at __PRINT, __STR_S, PRS and CDVARS.
CRTST:
  DEC HL
...
;
; Used by the routines at __READ and __CVD.
DTSTR:
  PUSH HL
  LD C,$FF
DTSTR_0:
...
;
; Used by the routines at ERRMOR, INPBAK, TSTANM, GETWORD_HL, DEPTR, IN_PRT,
; __USING, L670C and PROCHK.
PRS:
  CALL CRTST

; Print string at HL
;
; Used by the routines at __PRINT, __INPUT, __USING and CDVARS.
PRS1:
  CALL GSTRCU
  CALL LOADFP_0
  INC D
...
TESTR:
  ...
  INC HL
  EX DE,HL
; This entry point is used by the routines at L4193 and OUTDO.
TESTR_0:
  POP AF
  RET
TESTR_1:
  ...
  LD BC,$6C5A
  PUSH BC
; This entry point is used by the routines at OM_ERR, __FRE and CDVARS.
GARBGE:
  LD HL,(MEMSIZ)
TESTR_2:
  LD (FRETOP),HL
...
;
; Used by the routines at ISLETTER_A, __LEN, __INSTR, __CVD, __LSET, FNAME and
; __OPEN.
GETSTR:
  CALL TSTSTR
...
;
; Used by the routines at __INPUT, PASSA, __STR_S, PRS1 and __FRE.
GSTRCU:
  LD HL,(FACCU)

; Get string pointed by HL
;
; Used by the routines at __USING, CONCAT and __INSTR.
GSTRHL:
  EX DE,HL

; Get string pointed by DE
;
; Used by the routines at ISLETTER_A, CONCAT and __LEFT_S.
GSTRDE:
  CALL GSTRDE_1
  EX DE,HL
  RET NZ
...
GSTRDE_0:
  POP HL
  RET
; This entry point is used by the routine at __REM.
GSTRDE_1:
  LD HL,(TEMPPT)
  DEC HL
  LD B,(HL)
...
CSTSCN:
  CALL CHRGTB
; This entry point is used by the routines at CHAIN_COMMON and BCKUCM.
AFTCOM:
  OR A
  JR Z,CLPSCN
  CP $3A
...
; Routine at 29556
;
; Used by the routine at __CHAIN.
CHAIN_COMMON:
  CALL CHRGTB
  JR Z,AFTCOM
...
; Routine at 29803
;
; Used by the routines at __CHAIN and CLPAKP.
DNCMDA:
  LD HL,(VARTAB)
DNCMDA_0:
  EX DE,HL
...
CAYSTR_2:
  ...
  LD (MAXFILSV),A
  JP __LOAD_0
; This entry point is used by the routines at L670C and NOTRNL.
CHNRET:
  XOR A
  LD (CHNFLG),A
  LD (MRGFLG),A
...
; Routine at 30214
;
; Used by the routine at CDVARS.
NTRNDW:
  POP HL
  CALL L670C_8
  JP FINPRT
; This entry point is used by the routines at INPBAK and __CVD.
FILINP:
  LD C,$01

; Routine at 30223
;
; Used by the routines at __PRINT and CDVARS.
FILGET:
  CP $23
  RET NZ
  PUSH BC
...
; Routine at 30251
;
; Used by the routines at FILGET, __CLOSE, FN_INPUT and __GET.
FILSCN:
  DEC HL
  CALL CHRGTB
  CP $23
...
; Routine at 30266
;
; Used by the routines at CPM_CLSFIL and __OPEN.
FILIDX:
  LD E,A
...
__CLOSE_1:
  ...
  PUSH DE
  JP (HL)
; This entry point is used by the routines at OM_ERR, RUN_FST, __RESTORE and
; __OPEN.
__CLOSE_2:
  PUSH DE
  PUSH BC
...
; Routine at 31290
;
; Used by the routine at FN_INPUT.
INTCTC:
  LD HL,(SAVSTK)
  LD SP,HL
  JP ENDCON
...
INDSKB_5:
  ...
  POP DE
  RET
; This entry point is used by the routines at __EOF, CPM_CLSFIL and __OPEN.
INDSKB_6:
  PUSH BC
  PUSH DE
  PUSH HL
...
; Routine at 31755
;
; Used by the routines at L670C, __CVD, NOTRNL, OKGETM and DSKCHR.
RDBYT:
  CALL INDSKB
  RET C
  CP $1A
...
__OPEN_0:
  ...
  JP Z,BN_ERR
  POP DE
; This entry point is used by the routine at FILE_OPENOUT.
__OPEN_1:
  LD E,A
  PUSH DE
  CALL FILIDX
...
__OPEN_17:
  ...
  JR NZ,__OPEN_17
  RET
; This entry point is used by the routines at __EOF and INDSKB.
__OPEN_18:
  PUSH DE
  LD C,A
  PUSH BC
...
__OPEN_20:
  POP AF
  RET
; This entry point is used by the routine at NOTRNL.
__OPEN_21:
  EX DE,HL
  CALL __OPEN_23
  LD HL,(PTRFIL)
