...
;
	ORG	7BA0H
;	MODULE ENTRY POINTS
IOMOD	EQU	6200H	;IO MODULE
SCMOD	EQU	7100H	;SCANNER MODULE
SYMOD	EQU	7340H	;SYMBOL TABLE MODULE
BMOD	EQU	75A0H	;BINARY SEARCH MODULE
OPMOD	EQU	7860H	;OPERAND SCAN MODULE
;
