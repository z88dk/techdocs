...
;
	ORG	6200H
BOOT	EQU	6000H	;REBOOT LOCATION
...
;
;	DOS ENTRY POINTS
BDOS	EQU	6005H	;DOS ENTRY POINT
...
HBP:	DW	0
HBUFF:	DS	HSIZE
FCB	EQU	605CH	;FILE CONTROL BLOCK ADDRESS
FNM	EQU	1	;POSITION OF FILE NAME
FLN	EQU	9	;FILE NAME LENGTH
BUFF	EQU	6080H	;INPUT DISK BUFFER ADDRESS
;
