...
00000123:	CALL 012Dh		; set up interrupt vector
00000126:	CALL 013Ch
00000129:	EI
0000012A:	JP 14A0h
...
; 'LET'
0000166A:	CALL 8C2Eh		; get variable
0000166D:	PUSH BC
0000166E:	PUSH BC
0000166F:	PUSH AF
00001670:	CALL 8262h		; skip SPACEs in (HL)
00001673:	CP F4h
...
000017A8:	CALL 8262h		; skip SPACEs in (HL)
000017AB:	OR A
000017AC:	RET Z
000017AD:	CP 3Ah	; ':'
000017AF:	RET
...
0000181B:	CALL 8262h		; skip SPACEs in (HL)
0000181E:	LD (364Dh),A
...
000018D7:	PUSH BC
000018D8:	PUSH DE
000018D9:	CALL 8C2Eh		; get variable
000018DC:	POP DE
000018DD:	EX DE,HL
000018DE:	OR A
000018DF:	SBC HL,BC
...
0000199A:	CALL 8262h		; skip SPACEs in (HL)
...
00001A4F:	PUSH BC
00001A50:	EXX
00001A51:	CALL 8262h		; skip SPACEs in (HL)
00001A54:	CP 2Ch	; ','
00001A56:	RET NZ
00001A57:	INC HL
00001A58:	JP 19CAh
...
00001A9E:	INC HL
00001A9F:	CALL 7F95h		; Load BASIC parameter in A
00001AA2:	OR A
00001AA3:	JR NZ,+0Dh
00001AA5:	LD DE,693Ah
00001AA8:	CALL 8262h		; skip SPACEs in (HL)
00001AAB:	CP 2Ch	; ','
00001AAD:	JR NZ,-27h
00001AAF:	INC HL
00001AB0:	JR -2Ah
...
; 'PAUSE'
00001BAA:	CALL 7F95h		; Load BASIC parameter in A
00001BAD:	JR +08h
00001BAF:	LD A,09h
00001BB1:	CALL 1BF3h
00001BB4:	LD A,(364Eh)
...
00001BFC:	CALL 8BFDh
00001BFF:	PUSH BC
00001C00:	CALL 7F95h		; Load BASIC parameter in A
00001C03:	POP BC
00001C04:	PUSH AF
00001C05:	CALL 28FCh
00001C08:	POP AF
...
00001FA0:	CALL 8262h		; skip SPACEs in (HL)
00001FA3:	OR A
00001FA4:	RET Z
00001FA5:	CP 3Ah	; ':'
00001FA7:	RET Z
...
; 'ERROR'
00002073:	CALL 7F95h		; Load BASIC parameter in A
; Generate error message, error code in 'A'
00002076:	LD HL,0000h
00002079:	LD (91CEh),HL
...
000021A3:	RET Z
000021A4:	JP 30DBh
000021A7:	LD (A631h),HL
000021AA:	DEC H
000021AB:	LD (A62Fh),HL
000021AE:	RET

000021AF:	LD HL,(A635h)
000021B2:	LD (HL),00h
000021B4:	INC HL
000021B5:	LD (HL),00h
000021B7:	INC HL
...
; 'MAXFILES'
00002207:	CALL 7F95h		; Load BASIC parameter in A
0000220A:	CP 10h
...
000022A1:	INC HL
000022A2:	CALL 7F95h		; Load BASIC parameter in A
000022A5:	OR A
000022A6:	JR Z,+05h
000022A8:	CP 02h
...
000022BB:	INC HL
000022BC:	CALL 7F95h		; Load BASIC parameter in A
000022BF:	DEC A
000022C0:	CP 02h
...
000022CA:	CALL 8262h		; skip SPACEs in (HL)
000022CD:	CP 23h	; '#'
000022CF:	JR NZ,+28h
000022D1:	INC HL
000022D2:	CALL 7F95h		; Load BASIC parameter in A
...
000022FC:	PUSH DE
000022FD:	JR NZ,+0Ch
000022FF:	CALL 8262h		; skip SPACEs in (HL)
00002302:	CP 3Bh	; ';'
00002304:	JR Z,+04h
00002306:	CALL 2E76h
00002309:	LD A,23h
0000230B:	CALL 8C2Eh		; get variable
...
00002359:	XOR A
0000235A:	LD (2845h),A
0000235D:	CALL 8262h		; skip SPACEs in (HL)
00002360:	CP 23h	; '#'
00002362:	JP Z,23CFh
00002365:	CALL 22DBh
00002368:	JR NZ,+08h
0000236A:	CALL 8262h		; skip SPACEs in (HL)
0000236D:	CP 2Ch	; ','
0000236F:	INC HL
00002370:	JR Z,+06h
...
0000237C:	CALL 8C2Eh		; get variable
0000237F:	PUSH AF
00002380:	PUSH BC
...
000023B2:	EX HL,(SP)
000023B3:	CALL 8262h		; skip SPACEs in (HL)
000023B6:	OR A
000023B7:	JR Z,+0Fh
000023B9:	CP 2Ch	; ','
000023BB:	JR NZ,+05h
...
000023CF:	INC HL
000023D0:	CALL 7F95h		; Load BASIC parameter in A
000023D3:	CALL 6627h		; get file defined by stream number in A, out: IY=ptr
000023D6:	CALL 2E73h		; Check for comma ','
...
000023FE:	JP Z,2378h
00002401:	PUSH DE
00002402:	CALL 8C2Eh		; get variable
00002405:	LD (2869h),A
00002408:	LD (2866h),BC
0000240C:	EX HL,(SP)
0000240D:	LD DE,A73Fh			; KEYBM1
00002410:	EX DE,HL
00002411:	PUSH DE
...
00002442:	INC HL
00002443:	LD (HL),00h
00002445:	LD HL,A73Fh		; KEYBM1
00002448:	CALL 281Ah
0000244B:	POP DE
0000244C:	POP HL
0000244D:	CALL 8262h		; skip SPACEs in (HL)
00002450:	CP 2Ch	; ','
00002452:	RET NZ
00002453:	INC HL
00002454:	JR -55h
...
000024E9:	CALL 24FCh
000024EC:	CALL 7F95h		; Load BASIC parameter in A
000024EF:	CP 0Ah
000024F1:	JR Z,+05h
000024F3:	CP 07h
...
000024FC:	CALL 8262h		; skip SPACEs in (HL)
000024FF:	CP F4h
00002501:	INC HL
00002502:	RET Z
...
00002656:	PUSH DE
00002657:	LD DE,A73Fh		; KEYBM1
0000265A:	PUSH DE
0000265B:	LD A,EFh		; SUBCPU_GET_CLOCK
0000265D:	CALL 0023h		; subcpu (A=command, DE=result ptr?)
00002660:	POP DE
00002661:	POP HL
00002662:	CALL 9A09h		; Init space in HL to double precision value 0
00002665:	EX DE,HL
00002666:	LD A,(HL)
00002667:	INC HL
00002668:	LD B,(HL)
...
000026E3:	LD A,(HL)
000026E4:	INC HL
000026E5:	CP A0h		; Token for 'POKE'
000026E7:	JP Z,416Ah
000026EA:	CP C7h		; Token for 'KEY'
000026EC:	JP Z,9082h
000026EF:	CP C8h		; Token for 'KEY'+1
000026F1:	JR Z,+03h
...
000026FB:	EX DE,HL
000026FC:	PUSH DE
000026FD:	CALL 8262h		; skip SPACEs in (HL)
00002700:	CP F4h
...
0000270F:	CALL 8BFEh
00002712:	CALL 8C2Eh		; get variable
00002715:	CP 03h			; is variable type 'string' ?
00002717:	JP NZ,2060h		; ERROR: Type mismatch
0000271A:	PUSH BC
0000271B:	CALL 2E73h		; Check for comma ','
0000271E:	CALL 7F95h		; Load BASIC parameter in A
00002721:	OR A
00002722:	JP Z,206Fh		; ERROR: Illegal function call
00002725:	PUSH AF
00002726:	CALL 8262h		; skip SPACEs in (HL)
00002729:	CP 29h	; ')'
0000272B:	JR NZ,+04h
0000272D:	LD A,FFh
0000272F:	JR +06h
00002731:	CALL 2E76h
00002734:	CALL 7F95h		; Load BASIC parameter in A
00002737:	POP BC
00002738:	LD C,A
00002739:	PUSH BC
0000273A:	CALL 28FCh
0000273D:	CALL 8262h		; skip SPACEs in (HL)
00002740:	CP F4h
...
000027CA:	LD A,3Ah
000027CC:	LD (2845h),A
000027CF:	CALL 8C2Eh		; get variable
000027D2:	PUSH HL
000027D3:	LD (2869h),A
...
00002810:	POP HL
00002811:	CALL 8262h		; skip SPACEs in (HL)
00002814:	CP 2Ch	; ','
00002816:	RET NZ
00002817:	INC HL
00002818:	JR -50h
...
0000281E:	LD B,00h
00002820:	CALL 8262h		; skip SPACEs in (HL)
00002823:	CP 22h	; '"'
00002825:	JR NZ,+19h
00002827:	INC HL
00002828:	LD A,(HL)
...
00002833:	INC B
00002834:	JR -0Eh
00002836:	CALL 8262h		; skip SPACEs in (HL)
00002839:	CP 2Ch	; ','
0000283B:	JR NZ,+15h
0000283D:	INC HL
0000283E:	JR +12h
...
; Check for comma ','
00002E73:	CALL 8262h		; skip SPACEs in (HL)
00002E76:	CP 2Ch	; ','
...
; 'SWAP'
00002E7D:	CALL 8C2Eh		; get variable
00002E80:	PUSH AF
00002E81:	PUSH BC
00002E82:	CALL 2E73h		; Check for comma ','
00002E85:	CALL 8C2Eh		; get variable
00002E88:	POP DE
00002E89:	EX HL,(SP)
00002E8A:	CP H
...
00002EED:	CALL 2E73h		; Check for comma ','
00002EF0:	PUSH DE
00002EF1:	CALL 7F95h		; Load BASIC parameter in A
00002EF4:	POP BC
00002EF5:	OUT (C),A
00002EF7:	RET
...
00002F58:	JR Z,+23h
00002F5A:	CALL 2E73h		; Check for comma ','
00002F5D:	DEC HL
00002F5E:	CALL 8261h
00002F61:	CP 2Ch	; ','
00002F63:	JR Z,+10h
...
00002F6F:	JR Z,+0Ch
00002F71:	CALL 2E73h		; Check for comma ','
00002F74:	DEC HL
00002F75:	INC HL
...
00003191:	EXX
00003192:	POP BC
00003193:	CALL 8262h		; skip SPACEs in (HL)
00003196:	EX DE,HL
00003197:	POP HL
...
; 'ON'
0000340C:	CALL 8262h		; skip SPACEs in (HL)
...
00003453:	CALL 8262h		; skip SPACEs in (HL)
00003456:	CP 22h	; '"'
00003458:	JR Z,+18h
0000345A:	CP 0Bh
0000345C:	JR Z,+05h
...
; 'GO'
0000347A:	CALL 8262h		; skip SPACEs in (HL)
0000347D:	INC HL
...
; 'GOTO'
00003488:	CALL 8262h		; skip SPACEs in (HL)
0000348B:	INC HL
0000348C:	CP 0Ch
0000348E:	JR NZ,+0Dh
00003490:	CALL 316Ch
...
000034B7:	INC HL
000034B8:	CALL 8262h		; skip SPACEs in (HL)
000034BB:	CP 81h
000034BD:	JR Z,+0Ch
000034BF:	CP 82h
...
000034E9:	EX AF,AF'
000034EA:	INC HL
000034EB:	CALL 8262h		; skip SPACEs in (HL)
000034EE:	CP 2Ch	; ','
000034F0:	JR Z,+16h
000034F2:	CP 0Bh
000034F4:	RET NZ
...
000034FF:	OR 80h
00003501:	LD (BC),A
00003502:	CALL 8262h		; skip SPACEs in (HL)
00003505:	CP 2Ch	; ','
00003507:	RET NZ
00003508:	INC DE
00003509:	INC DE
...
0000351D:	RET NZ
0000351E:	INC HL
0000351F:	CALL 8262h		; skip SPACEs in (HL)
00003522:	CP 0Bh
00003524:	JP Z,348Bh
00003527:	CP 0Ch
00003529:	JP Z,348Bh
...
000035B1:	CALL 8262h		; skip SPACEs in (HL)
000035B4:	CALL 53F8h		;
000035B7:	CP 5Bh
000035B9:	RET NC
000035BA:	SUB 41h
...
000035F6:	CALL 2E73h		; Check for comma ','
000035F9:	CALL 7F95h		; Load BASIC parameter in A
000035FC:	LD (361Dh),A
000035FF:	XOR A
00003600:	LD (361Bh),A
...
00003606:	JR Z,+07h
00003608:	INC HL
00003609:	CALL 7F95h		; Load BASIC parameter in A
0000360C:	LD (361Bh),A
...
; 'POKE'
00003664:	CALL 8262h		; skip SPACEs in (HL)
00003667:	CP 40h
00003669:	JR Z,+0Eh
...
00003696:	PUSH DE
00003697:	INC HL
00003698:	CALL 7F95h		; Load BASIC parameter in A
0000369B:	POP DE
0000369C:	RET

; 'LOCATE', 'CURSOR'
0000369D:	CALL 7F95h		; Load BASIC parameter in A
...
000036AE:	CALL 2E73h		; Check for comma ','
000036B1:	CALL 7F95h		; Load BASIC parameter in A
...
; 'WIDTH'
000036C6:	CALL 7F95h		; Load BASIC parameter in A
000036C9:	PUSH HL
...
000037E9:	CALL 3D58h
000037EC:	RET Z
000037ED:	CALL 2E73h		; Check for comma ','
000037F0:	CALL 8BFEh
000037F3:	CALL 387Ah
000037F6:	PUSH DE
...
000037FA:	CALL 3872h
000037FD:	POP HL
000037FE:	CALL 2E73h		; Check for comma ','
00003801:	CALL 387Ah
00003804:	PUSH DE
...
00003810:	CALL 8262h		; skip SPACEs in (HL)
...
0000383C:	CALL 3872h
0000383F:	POP HL
00003840:	CALL 2E73h		; Check for comma ','
00003843:	CALL 387Ah
00003846:	PUSH DE
00003847:	LD A,05h
...
000038B9:	JP 8262h		; skip SPACEs in (HL)
...
000038C8:	PUSH DE
000038C9:	CALL 2E73h		; Check for comma ','
...
000038E8:	ADD HL,DE
000038E9:	EX HL,(SP)
000038EA:	CALL 2E73h		; Check for comma ','
000038ED:	CALL 387Ah
000038F0:	PUSH DE
...
00003906:	POP HL
00003907:	POP BC
00003908:	JP 8262h		; skip SPACEs in (HL)
...
00003933:	CALL 393Fh
00003936:	JR -0Bh
00003938:	LD BC,1800h		; CRTC
0000393B:	LD (0016h),BC		; CURYST
...
0000394B:	LD D,00h
0000394D:	LD E,A
0000394E:	CALL 8262h		; skip SPACEs in (HL)
00003951:	CP 2Ch	; ','
00003953:	JR Z,+05h
00003955:	PUSH BC
00003956:	CALL 7F95h		; Load BASIC parameter in A
00003959:	POP BC
0000395A:	CALL 2E73h		; Check for comma ','
0000395D:	LD C,E
0000395E:	PUSH BC
0000395F:	CALL 7F95h		; Load BASIC parameter in A
00003962:	POP BC
00003963:	DEC A
...
000039A4:	LD B,(HL)
000039A5:	INC HL
000039A6:	LD DE,A73Fh		; KEYBM1
000039A9:	CALL 39BDh
000039AC:	LD DE,A73Fh		; KEYBM1
000039AF:	CALL 142Fh
000039B2:	INC C
000039B3:	LD A,C
000039B4:	CP 0Ah
...
00003A64:	CALL 8262h		; skip SPACEs in (HL)
00003A67:	CP 87h
00003A69:	INC HL
...
00003A75:	JR Z,-32h
00003A77:	DEC HL
00003A78:	CALL 7F95h		; Load BASIC parameter in A
00003A7B:	CP 0Bh
00003A7D:	JP NC,206Fh		; ERROR: Illegal function call
00003A80:	EX AF,AF'
00003A81:	CALL 8262h		; skip SPACEs in (HL)
00003A84:	INC HL
00003A85:	CALL 3A33h
00003A88:	JR Z,-36h
00003A8A:	CP 2Ch	; ','
...
00003B1D:	CALL 4AB0h
00003B20:	PUSH AF
00003B21:	CALL 8262h		; skip SPACEs in (HL)
00003B24:	CALL 2E73h		; Check for comma ','
00003B27:	CALL 4AB0h
00003B2A:	POP DE
00003B2B:	LD E,A
00003B2C:	LD A,D
...
00003B55:	CALL 3D58h
00003B58:	LD E,00h
00003B5A:	CALL NZ,7F95h		; Load BASIC parameter in A
00003B5D:	LD A,E
00003B5E:	LD (00F9h),A
00003B61:	CALL 3B6Ah
...
00003BE9:	DEC HL
00003BEA:	CALL 2E73h		; Check for comma ','
00003BED:	PUSH DE
00003BEE:	PUSH BC
...
00003C7C:	LD E,A
00003C7D:	LD D,00h
00003C7F:	CALL 8262h		; skip SPACEs in (HL)
00003C82:	CP 2Ch	; ','
00003C84:	PUSH BC
...
00003C97:	CALL 8262h		; skip SPACEs in (HL)
00003C9A:	CP 2Ch	; ','
00003C9C:	JR NZ,+0Ch
00003C9E:	INC HL
00003C9F:	CALL 7F95h		; Load BASIC parameter in A
...
00003CB6:	CP 2Ch	; ','
00003CB8:	JR Z,-23h
00003CBA:	CALL 7F95h		; Load BASIC parameter in A
00003CBD:	CP 04h
00003CBF:	JR Z,-13h
...
; 'LINE'
00003D6E:	CALL 8262h		; skip SPACEs in (HL)
...
00003D79:	CALL 3DC0h
00003D7C:	CALL 8262h		; skip SPACEs in (HL)
...
00003DB4:	CALL 3EC9h
00003DB7:	POP HL
00003DB8:	CALL 8262h		; skip SPACEs in (HL)
...
00003DDA:	INC HL
00003DDB:	CALL 8262h		; skip SPACEs in (HL)
00003DDE:	CP EAh
00003DE0:	LD E,00h
00003DE2:	JR Z,+22h
00003DE4:	CP FEh
...
00003E39:	JR Z,+71h
00003E3B:	CALL 2E76h
00003E3E:	CALL 8262h		; skip SPACEs in (HL)
00003E41:	CALL 53F8h
00003E44:	CP 42h	; 'B'
00003E46:	JR Z,+1Eh
00003E48:	CP 2Ch	; ','
...
00003E57:	JR Z,+53h
00003E59:	CALL 2E76h
00003E5C:	CALL 8262h		; skip SPACEs in (HL)
00003E5F:	CALL 53F8h
00003E62:	CP 42h	; 'B'
00003E64:	JR NZ,+58h
00003E66:	LD BC,3FB3h
00003E69:	INC HL
00003E6A:	CALL 8262h		; skip SPACEs in (HL)
00003E6D:	CALL 53F8h
00003E70:	CP 46h
00003E72:	JR NZ,+42h
00003E74:	INC HL
...
00003E7F:	CALL 3D58h
00003E82:	JR +28h
00003E84:	CALL 2E73h		; Check for comma ','
00003E87:	CALL 7FB9h
00003E8A:	PUSH HL
00003E8B:	PUSH DE
00003E8C:	LD DE,(3621h)		; TMPEND
00003E90:	LD HL,0258h
00003E93:	ADD HL,DE
00003E94:	EX DE,HL
00003E95:	CALL 8D3Ch
00003E98:	POP DE
...
00003FAB:	PUSH DE
00003FAC:	PUSH HL
00003FAD:	CALL C,4139h		; SMC, call address changes
00003FB0:	POP HL
00003FB1:	POP DE
00003FB2:	RET
...
00004176:	PUSH AF
00004177:	CALL 8262h		; skip SPACEs in (HL)
0000417A:	CP F4h
...
; 'CREV'
0000419D:	LD A,00h
0000419F:	CALL NZ,7F95h		; Load BASIC parameter in A
000041A2:	OR A
000041A3:	LD C,F7h
000041A5:	LD B,00h
000041A7:	JR Z,+02h
...
; 'CFLASH'
000041B4:	LD A,00h
000041B6:	CALL NZ,7F95h		; Load BASIC parameter in A
000041B9:	LD C,EFh
000041BB:	OR A
000041BC:	LD B,00h
000041BE:	JR Z,-15h
...
; 'CGEN'
000041C4:	LD A,00h
000041C6:	CALL NZ,7F95h		; Load BASIC parameter in A
000041C9:	LD C,DFh
000041CB:	OR A
000041CC:	LD B,00h
000041CE:	JR Z,-25h
...
; 'CSIZE'
000041D4:	LD A,00h
000041D6:	CALL NZ,7F95h		; Load BASIC parameter in A
000041D9:	LD (53AAh),A
000041DC:	RRCA
000041DD:	RRCA
000041DE:	LD B,A
...
000041F3:	CALL 2E73h		; Check for comma ','
000041F6:	LD (43F8h),BC
000041FA:	LD (43FFh),DE
000041FE:	CALL 387Ah
00004201:	PUSH DE
00004202:	PUSH HL
00004203:	LD DE,A73Fh		; KEYBM1
00004206:	CALL 3872h
00004209:	POP HL
0000420A:	LD A,(5384h)
0000420D:	OR A
...
000047B5:	CALL 7F95h		; Load BASIC parameter in A
000047B8:	CP 02h
...
00004831:	CALL 3D58h
00004834:	JR Z,+0Eh
00004836:	CALL 2E73h		; Check for comma ','
00004839:	PUSH BC
0000483A:	PUSH DE
0000483B:	CALL 7F95h		; Load BASIC parameter in A
0000483E:	POP DE
0000483F:	POP BC
00004840:	INC DE
00004841:	LD (DE),A
...
00004A6F:	LD A,(40F9h)
00004A72:	JP Z,4828h
00004A75:	CALL 2E73h		; Check for comma ','
00004A78:	CALL 4AB0h
00004A7B:	JP 4828h
00004A7E:	LD C,A
00004A7F:	LD B,A
00004A80:	EXX
00004A81:	LD BC,0258h
00004A84:	EXX
...
00004AB0:	CALL 7F95h		; Load BASIC parameter in A
00004AB3:	CP 08h
00004AB5:	RET C
...
00004BFD:	CALL 8262h		; skip SPACEs in (HL)
00004C00:	CALL 2E76h
00004C03:	CALL 4C1Bh
00004C06:	CP 08h
00004C08:	RET C
...
00004C0C:	CALL 8262h		; skip SPACEs in (HL)
00004C0F:	CALL 2E76h
00004C12:	CALL 4C1Bh
00004C15:	DEC A
00004C16:	CP 04h
...
00004C19:	JR -12h
00004C1B:	PUSH DE
00004C1C:	CALL 7F95h		; Load BASIC parameter in A
00004C1F:	POP DE
00004C20:	RET
...
00004C82:	JR Z,+6Fh
00004C84:	CALL 2E76h
00004C87:	CALL 7F95h		; Load BASIC parameter in A
00004C8A:	OR A
00004C8B:	RET Z
00004C8C:	CP 08h
...
00004E9E:	CALL 2E76h
00004EA1:	CALL 8262h		; skip SPACEs in (HL)
00004EA4:	CP FEh
00004EA6:	JR Z,+0Eh
00004EA8:	CP EEh
...
00004EDC:	EX DE,HL
00004EDD:	CALL 2E73h		; Check for comma ','
00004EE0:	CALL 7F95h		; Load BASIC parameter in A
00004EE3:	OR A
00004EE4:	RET Z
00004EE5:	CP 08h
...
00004FA4:	CALL 4FB5h
00004FA7:	POP HL
00004FA8:	CALL 8262h		; skip SPACEs in (HL)
00004FAB:	CP 2Ch	; ','
00004FAD:	RET NZ
00004FAE:	INC HL
00004FAF:	JR -11h
...
000050EC:	JR Z,+16h
000050EE:	CALL 7F95h		; Load BASIC parameter in A
...
; 'CRT'
00005371:	CALL 7F95h		; Load BASIC parameter in A
00005374:	CP 04h
00005376:	JR NC,-2Ah
00005378:	ADD 1Ch
0000537A:	JR -52h
...
000053B4:	CALL 9A09h		; Init space in HL to double precision value 0
000053B7:	LD A,E
000053B8:	OR D
000053B9:	RET Z
000053BA:	BIT 7,D
...
000054FB:	CALL 9A09h		; Init space in HL to double precision value 0
000054FE:	LD (A5F7h),A
00005501:	LD (A5F8h),A
00005504:	LD (A5F9h),A
00005507:	LD (A5FAh),A
...
000056BD:	LD HL,(A5F4h)
000056C0:	LD B,00h
000056C2:	LD DE,5C55h
000056C5:	CALL 56B7h
000056C8:	JR C,+06h
000056CA:	CALL 5662h
000056CD:	INC B
...
000058B5:	JR -09h
000058B7:	LD (HL),00h
000058B9:	LD DE,A73Fh		; KEYBM1
000058BC:	RET

000058BD:	LD (A5F4h),HL
000058C0:	XOR A
000058C1:	LD (A5F7h),A
000058C4:	LD (A5F8h),A
000058C7:	LD B,31h
...
00005975:	LD DE,A5ACh
00005978:	LD (DE),A
00005979:	DEC DE
0000597A:	RET

0000597B:	JP C,56BDh
0000597E:	LD HL,(A5F4h)
00005981:	LD A,(HL)
00005982:	OR A
00005983:	JR Z,-10h
00005985:	CALL 5A05h
...
000059BE:	JR Z,-14h
000059C0:	INC HL
000059C1:	LD DE,A5ACh
000059C4:	EX DE,HL
000059C5:	OR A
000059C6:	SBC HL,DE
000059C8:	EX DE,HL
000059C9:	JR C,+05h
000059CB:	LD HL,A5ACh
000059CE:	JR +21h
000059D0:	DEC HL
000059D1:	LD A,(HL)
000059D2:	CP 2Eh	; '.'
...
000059E0:	LD DE,A5BDh
000059E3:	CP 05h			; Single precision type ?
000059E5:	JR NZ,+03h
000059E7:	LD DE,A5B5h
000059EA:	SBC HL,DE
000059EC:	POP HL
000059ED:	JP NC,56BDh
000059F0:	INC HL
000059F1:	LD (HL),00h
000059F3:	CALL 5A05h
000059F6:	LD A,(DE)
...
00005A08:	LD DE,A59Ch
00005A0B:	CP 08h		; double precision type ?
00005A0D:	RET Z
00005A0E:	LD DE,A5A4h
00005A11:	RET

00005A12:	LD HL,A59Ch
00005A15:	LD (HL),31h
00005A17:	INC HL
00005A18:	LD (HL),44h
...
00005A89:	CALL 9A09h		; Init space in HL to double precision value 0
00005A8C:	POP DE
00005A8D:	POP HL
00005A8E:	POP BC
00005A8F:	RET
...
00005B65:	JP Z,9A09h		; Init space in HL to double precision value 0
00005B68:	LD A,(HL)
00005B69:	OR A
00005B6A:	RET Z
00005B6B:	INC HL
...
00005CF2:	POP HL
00005CF3:	CALL 8262h		; skip SPACEs in (HL)
00005CF6:	CALL 2E76h
00005CF9:	CALL 5D66h
00005CFC:	PUSH HL
...
00005D27:	LDIR
00005D29:	POP HL
00005D2A:	CALL 8262h		; skip SPACEs in (HL)
00005D2D:	CALL 2E76h
00005D30:	CALL 7FB9h
00005D33:	PUSH HL
00005D34:	CP 80h
...
00005D66:	CALL 8C2Eh		; get variable
...
00005D74:	CALL 6702h
00005D77:	CALL 8262h		; skip SPACEs in (HL)
00005D7A:	CALL 2E76h
...
00005E6B:	JR NZ,+01h
00005E6D:	INC HL
00005E6E:	CALL 7F95h		; Load BASIC parameter in A
...
00005E81:	CALL 8262h		; skip SPACEs in (HL)
00005E84:	CALL 2E76h
00005E87:	PUSH DE
00005E88:	PUSH BC
00005E89:	CALL 7F95h		; Load BASIC parameter in A
00005E8C:	PUSH DE
00005E8D:	CALL 5EC0h
00005E90:	CALL 8C2Eh		; get variable
00005E93:	PUSH HL
...
00005EBD:	RET Z
00005EBE:	JR -3Fh
00005EC0:	CALL 8262h		; skip SPACEs in (HL)
00005EC3:	CALL 53F8h
00005EC6:	CP 41h
00005EC8:	JR NZ,+09h
00005ECA:	INC HL
...
00005EFB:	JR -1Ah
00005EFD:	LD (6007h),A
00005F00:	CALL 8262h		; skip SPACEs in (HL)
00005F03:	CP 23h	; '#'
00005F05:	JR NZ,+01h
00005F07:	INC HL
00005F08:	CALL 7F95h		; Load BASIC parameter in A
...
; 'ATTR$'
0000602B:	PUSH DE
0000602C:	CALL 8262h		; skip SPACEs in (HL)
0000602F:	CALL 8C01h
00006032:	CALL 7FDEh
...
0000608E:	LD (HL),B
0000608F:	POP HL
00006090:	JP 8262h		; skip SPACEs in (HL)
...
; Entry for 'SET #'
000060D9:	INC HL
000060DA:	CALL 7F95h		; Load BASIC parameter in A
000060DD:	OR A
...
0000610C:	INC HL
0000610D:	CALL 8262h		; skip SPACEs in (HL)
...
00006118:	INC HL
00006119:	CALL 7F95h		; Load BASIC parameter in A
...
00006126:	CALL 8262h		; skip SPACEs in (HL)
00006129:	CP 2Ch	; ','
0000612B:	JR Z,-21h
0000612D:	RET
; no '#' specified
...
000061C9:	CALL 8262h		; skip SPACEs in (HL)
000061CC:	CP 22h	; '"'
000061CE:	JR Z,+15h
000061D0:	PUSH HL
...
0000620A:	CALL 65FBh
0000620D:	POP HL
0000620E:	CALL 3088h			; GTSTED:
00006211:	LD (6229h),DE
00006215:	LD (6237h),BC
00006219:	PUSH HL
0000621A:	LD HL,(A635h)
0000621D:	CALL 1773h
00006220:	JR Z,+6Dh
00006222:	PUSH DE
00006223:	LD E,(HL)
...
0000630F:	JR Z,+17h
00006311:	CALL 2E76h
00006314:	CALL 8262h		; skip SPACEs in (HL)
00006317:	CP 2Ch	; ','
00006319:	JR Z,+0Dh
0000631B:	PUSH BC
0000631C:	PUSH DE
...
00006350:	CALL 6822h
00006353:	POP HL
00006354:	CALL 8262h		; skip SPACEs in (HL)
00006357:	CP 2Ch	; ','
00006359:	RET NZ
0000635A:	INC HL
0000635B:	CALL 8262h		; skip SPACEs in (HL)
0000635E:	CP 52h
...
000063D7:	DEC DE
000063D8:	DEC DE
000063D9:	LD HL,(A635h)
000063DC:	CALL A47Dh
000063DF:	LD IY,(A62Bh)		; STRST
000063E3:	LD HL,(A635h)
...
00006401:	LD DE,14ECh
00006404:	CALL 8262h		; skip SPACEs in (HL)
00006407:	CP 2Ch	; ','
00006409:	RET NZ
0000640A:	INC HL
0000640B:	CALL 8262h		; skip SPACEs in (HL)
0000640E:	CALL 53F8h
00006411:	CP 52h
00006413:	RET NZ
...
00006454:	PUSH DE
00006455:	EX DE,HL
00006456:	CALL 8262h		; skip SPACEs in (HL)
00006459:	CP 3Ah	; ':'
0000645B:	JR NC,+07h
0000645D:	CP 30h
0000645F:	JR C,+03h
...
000064E4:	JR Z,+0Fh
000064E6:	CALL 2E76h
000064E9:	CALL 8262h		; skip SPACEs in (HL)
000064EC:	CP 41h			;
...
; 'CLOSE'
00006547:	JR Z,+1Dh
00006549:	CALL 8262h		; skip SPACEs in (HL)
0000654C:	OR A
0000654D:	RET Z
0000654E:	CP 23h	; '#'
00006550:	JR NZ,+01h
00006552:	INC HL
00006553:	CALL 7F95h		; Load BASIC parameter in A
00006556:	OR A
00006557:	JP Z,688Fh			; ERROR: Bad file number
0000655A:	CALL 6573h
0000655D:	CALL 8262h		; skip SPACEs in (HL)
00006560:	CP 2Ch	; ','
00006562:	RET NZ
00006563:	INC HL
00006564:	JR -1Dh
...
000065D8:	CALL 2E73h		; Check for comma ','
000065DB:	CALL 8262h		; skip SPACEs in (HL)
000065DE:	CP 23h	; '#'
000065E0:	JR NZ,+01h
000065E2:	INC HL
000065E3:	CALL 7F95h		; Load BASIC parameter in A
000065E6:	OR A
000065E7:	JP Z,688Fh			; ERROR: Bad file number
000065EA:	CALL 6636h			; check stream/file number in A, out: DE=offset
000065ED:	PUSH DE
000065EE:	CALL 2E73h		; Check for comma ','
000065F1:	CALL 6659h
000065F4:	EXX
000065F5:	POP DE
...
000067EE:	CALL 681Ch
000067F1:	LD A,39h
000067F3:	JP NZ,68A6h
000067F6:	LD HL,FF00h		; -256
000067F9:	LD DE,A73Fh		; KEYBM1
...
0000709D:	LD HL,A73Fh		; KEYBM1
000070A0:	LD A,01h
000070A2:	PUSH DE
000070A3:	CALL 7063h
000070A6:	LD BC,0820h
000070A9:	LD HL,A73Fh		; KEYBM1
000070AC:	LD A,(HL)
000070AD:	CP FFh
000070AF:	JR Z,+1Dh
000070B1:	BIT 4,A
...
000070D3:	LD HL,A73Fh		; KEYBM1
000070D6:	LD B,00h
000070D8:	LD A,FFh
000070DA:	LD (HL),A
000070DB:	INC HL
000070DC:	DJNZ -04h
000070DE:	LD HL,A73Fh		; KEYBM1
000070E1:	PUSH DE
000070E2:	LD A,01h
000070E4:	CALL 705Dh
000070E7:	POP DE
...
000070EA:	CP 10h
000070EC:	JR NC,-10h
000070EE:	LD HL,A73Fh		; KEYBM1
000070F1:	LD B,00h
000070F3:	XOR A
000070F4:	LD (HL),A
000070F5:	INC HL
000070F6:	DJNZ -04h
000070F8:	LD HL,A73Fh		; KEYBM1
000070FB:	LD DE,000Fh
000070FE:	LD A,01h
00007100:	CALL 705Dh
00007103:	LD HL,A73Fh		; KEYBM1
00007106:	LD (HL),01h
00007108:	INC HL
00007109:	LD (HL),8Fh
0000710B:	LD A,(74BFh)
...
00007FDB:	JP 8262h		; skip SPACEs in (HL)
...
; EXPR4:
00008090:	CALL 8262h		; skip SPACEs in (HL)
...
00008178:	POP DE
00008179:	POP HL
0000817A:	CALL 8262h		; skip SPACEs in (HL)
0000817D:	JR -3Bh
0000817F:	PUSH HL
00008180:	PUSH DE
...
000081B6:	INC HL
; EXPRZ:
000081B7:	CALL 8262h		; skip SPACEs in (HL)
...
000081D7:	INC HL
000081D8:	CALL 8262h		; skip SPACEs in (HL)
...
00008239:	DJNZ -04h
0000823B:	POP DE
0000823C:	CALL 8262h		; skip SPACEs in (HL)
0000823F:	INC HL
00008240:	CP 7Fh
00008242:	JP Z,82E5h
00008245:	CP D0h
...
000082E5:	PUSH DE
000082E6:	CALL 8262h		; skip SPACEs in (HL)
000082E9:	CP 23h	; '#'
000082EB:	LD A,05h
000082ED:	JR NZ,+03h
000082EF:	INC HL
...
00008323:	PUSH HL
00008324:	INC B
00008325:	LD DE,A73Fh			; KEYBM1
00008328:	LD HL,(3621h)		; TMPEND
0000832B:	CALL 8D2Dh			; STRENT:
0000832E:	LD B,00h
00008330:	LD HL,(91CEh)
00008333:	CALL 8262h		; skip SPACEs in (HL)
00008336:	CP F4h
00008338:	JR Z,+2Fh
0000833A:	CP 28h	; '('
...
00008351:	LD DE,A73Fh			; KEYBM1
00008354:	CALL 1292h
00008357:	POP HL
00008358:	POP BC
00008359:	JR Z,+24h
0000835B:	CALL 8262h		; skip SPACEs in (HL)
0000835E:	CP 29h	; ')'
00008360:	JR Z,+07h
00008362:	CP 2Ch	; ','
00008364:	JR Z,-27h
...
000083A2:	EX HL,(SP)
000083A3:	EX DE,HL
000083A4:	LD BC,(91CEh)
000083A8:	PUSH BC
000083A9:	LD BC,0000h
000083AC:	LD (91CEh),BC
000083B0:	CALL 7FDEh
000083B3:	POP HL
000083B4:	LD (91CEh),HL
000083B7:	POP HL
000083B8:	JP 8262h		; skip SPACEs in (HL)
000083BB:	PUSH DE
000083BC:	JP 8C35h
000083BF:	CP 91h
000083C1:	JP Z,8D4Ah
...
000083F8:	POP HL
000083F9:	POP DE
000083FA:	JP 8262h		; skip SPACEs in (HL)
...
00008422:	PUSH AF
00008423:	INC HL
00008424:	CALL 8262h		; skip SPACEs in (HL)
00008427:	CP 28h	; '('
00008429:	JR NZ,+03h
0000842B:	INC HL
0000842C:	JR -49h
...
0000847C:	EX DE,HL
0000847D:	POP HL
0000847E:	JP 8262h		; skip SPACEs in (HL)
...
00008523:	EX DE,HL
00008524:	CALL 9A09h		; Init space in HL to double precision value 0
00008527:	LD (HL),91h
00008529:	EX DE,HL
...
00008565:	POP DE
00008566:	CALL 856Ch
00008569:	JP 8262h		; skip SPACEs in (HL)
...
0000864E:	POP HL
0000864F:	CALL 9A09h		; Init space in HL to double precision value 0
00008652:	JP 858Ah
...
; 'VARPTR'
00008764:	CALL 8BFEh
00008767:	CALL 8262h		; skip SPACEs in (HL)
0000876A:	CP 23h	; '#'
0000876C:	JR Z,+0Fh
0000876E:	CALL 8C31h
00008771:	CALL 8262h		; skip SPACEs in (HL)
...
; 'CMT'
00008798:	CALL 8262h		; skip SPACEs in (HL)
0000879B:	CP 28h	; '('
0000879D:	JR Z,+15h
...
000087B1:	JP 8262h		; skip SPACEs in (HL)
...
000088B7:	EX DE,HL
000088B8:	POP HL
000088B9:	JP 8262h		; skip SPACEs in (HL)

; 'INKEY$'
000088BC:	CALL 8262h		; skip SPACEs in (HL)
000088BF:	CP 28h	; '('
000088C1:	LD A,FFh
000088C3:	JR NZ,+11h
000088C5:	INC HL
...
00008A96:	EX DE,HL
00008A97:	JP 8262h		; skip SPACEs in (HL)
...
00008B5B:	POP HL
00008B5C:	POP DE
00008B5D:	JP 8262h		; skip SPACEs in (HL)
...
00008B95:	POP DE
00008B96:	POP HL
00008B97:	JP 8262h		; skip SPACEs in (HL)
...
00008BA0:	EX DE,HL
00008BA1:	ADD HL,HL
00008BA2:	LD BC,A615h
00008BA5:	ADD HL,BC
00008BA6:	RET

00008BA7:	CALL 8262h		; skip SPACEs in (HL)
00008BAA:	SUB C
00008BAB:	RET Z
00008BAC:	ADD C
00008BAD:	DEC A
...
00008BF6:	CALL 7FDEh
00008BF9:	POP HL
00008BFA:	JP 8262h		; skip SPACEs in (HL)


00008BFD:	INC HL

00008BFE:	CALL 8262h		; skip SPACEs in (HL)
00008C01:	CP 28h	; '('
00008C03:	INC HL
00008C04:	RET Z
...
00008D69:	PUSH DE
00008D6A:	PUSH BC
00008D6B:	CALL 8262h		; skip SPACEs in (HL)
00008D6E:	CP 23h	; '#'
00008D70:	JR NZ,+01h
00008D72:	INC HL
...
00008E34:	PUSH DE
00008E35:	PUSH BC
00008E36:	LD BC,(91B6h)
00008E3A:	LD A,(91BAh)
00008E3D:	PUSH BC
00008E3E:	PUSH AF
00008E3F:	LD BC,(A59Ch)
00008E43:	PUSH BC
00008E44:	CALL 7F9Fh		; DEEXP:
00008E47:	EX AF,AF'
00008E48:	BIT 7,D
00008E4A:	JP NZ,2033h		; ERROR: Subscript out of range
00008E4D:	POP BC
00008E4E:	LD (A59Ch),BC
00008E52:	POP AF
00008E53:	LD (91BAh),A
00008E56:	POP BC
00008E57:	LD (91B6h),BC
00008E5B:	EX AF,AF'
00008E5C:	INC HL
00008E5D:	CP 29h	; ')'
00008E5F:	JR Z,+12h
...
00009037:	OR A
00009038:	JR Z,+04h
0000903A:	LD HL,(A59Ch)
0000903D:	RET

0000903E:	LD HL,(91B6h)
00009041:	PUSH DE
00009042:	JP 8E10h
00009045:	LD B,A
00009046:	LD A,(DE)
...
00009073:	CALL 8C01h
00009076:	CALL 8E02h
00009079:	CALL 8262h		; skip SPACEs in (HL)
0000907C:	CP 2Ch	; ','
0000907E:	RET NZ
0000907F:	INC HL
00009080:	JR -13h
...
00009105:	LD DE,(91CEh)
00009109:	LD (91CEh),HL
0000910C:	PUSH DE
0000910D:	PUSH IX
0000910F:	DEC HL
...
00009141:	ADD HL,BC
00009142:	EX DE,HL
00009143:	CALL 8262h		; skip SPACEs in (HL)
00009146:	CP 28h	; '('
00009148:	RET NZ
00009149:	PUSH DE
0000914A:	LD B,01h
...
00009163:	DJNZ -19h
00009165:	INC HL
00009166:	CALL 8262h		; skip SPACEs in (HL)
00009169:	POP DE
0000916A:	RET
...
000091DF:	DEC (HL)
000091E0:	RET NZ
000091E1:	JP 9A09h		; Init space in HL to double precision value 0

; ADDHL5:	pick 8 more bytes from the number queue (HL ptr)
000091E4:	PUSH HL
000091E5:	LD DE,0008h
000091E8:	ADD HL,DE
000091E9:	EX DE,HL
...
0000940F:	LD DE,93C9h
00009412:	CALL 9C39h		; CMP:
00009415:	JR C,+52h
00009417:	LD DE,93CBh
...
0000956F:	CP 5Ch	; '\'
00009571:	RET NC
00009572:	JP 9A09h		; Init space in HL to double precision value 0

00009575:	CP 4Dh
00009577:	JR -08h
00009579:	CALL 91DCh		; DIVTWO:
0000957C:	LD DE,96B2h		; PI
...
; Init space in HL to double precision value 0
00009A09:	PUSH HL
00009A0A:	LD B,08h
00009A0C:	XOR A
00009A0D:	LD (HL),A
