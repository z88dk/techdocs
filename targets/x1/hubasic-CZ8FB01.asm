...
00002660:	POP DE
00002661:	POP HL
00002662:	CALL 9A09h		; CLRFAC: Init space in HL to double precision value 0
00002665:	EX DE,HL
00002666:	LD A,(HL)
00002667:	INC HL
00002668:	LD B,(HL)
...
; FLTHEX:  (HL)=DE
000053B4:	CALL 9A09h		; CLRFAC: Init space in HL to double precision value 0
000053B7:	LD A,E
000053B8:	OR D
000053B9:	RET Z
000053BA:	BIT 7,D
...
000054FB:	CALL 9A09h		; CLRFAC: Init space in HL to double precision value 0
...
00005A89:	CALL 9A09h		; CLRFAC: Init space in HL to double precision value 0
00005A8C:	POP DE
00005A8D:	POP HL
00005A8E:	POP BC
00005A8F:	RET
...
00005B65:	JP Z,9A09h		; CLRFAC: Init space in HL to double precision value 0
00005B68:	LD A,(HL)
00005B69:	OR A
00005B6A:	RET Z
00005B6B:	INC HL
...
00008523:	EX DE,HL
00008524:	CALL 9A09h		; CLRFAC: Init space in HL to double precision value 0
00008527:	LD (HL),91h
00008529:	EX DE,HL
...
0000864E:	POP HL
0000864F:	CALL 9A09h		; CLRFAC: Init space in HL to double precision value 0
00008652:	JP 858Ah
...
000091DF:	DEC (HL)
000091E0:	RET NZ
000091E1:	JP 9A09h		; CLRFAC: Init space in HL to double precision value 0
...
0000956F:	CP 5Ch	; '\'
00009571:	RET NC
00009572:	JP 9A09h		; CLRFAC: Init space in HL to double precision value 0
...
; CLRFAC: Init space in HL to double precision value 0
00009A09:	PUSH HL
00009A0A:	LD B,08h
00009A0C:	XOR A
00009A0D:	LD (HL),A
